...
#該程式非freestyle程式!
{<section id="axcp950.description" type="s" >}
#應用 a00 樣板自動產生(Version:3)
#+ Standard Version.....: SD版次:0009(2016-07-21 14:34:16), PR版次:0009(2017-04-27 11:05:57)
...
{<section id="axcp950.global" type="s" >}
...
#170302-00012#9   2017/03/14 By 08734     整批调整未产生数据时，提示消息修正。
#160711-00040#4   2017/04/27 By 08734     T類作業的單別開窗的where條件(找CALL q_ooba002_開頭的)增加如下程式段
...
DEFINE g_flag         LIKE type_t.num5  #170302-00012#9   2017/03/14  By 08734 add
#end add-point
...
{<section id="axcp950.main" type="s" >}
MAIN
...
{<section id="axcp950.init" type="s" >}
#+ 初始化作業
...
{<section id="axcp950.ui_dialog" type="s" >}
#+ 選單功能實際執行處
PRIVATE FUNCTION axcp950_ui_dialog()
   ...
   DEFINE l_sql1     STRING   #160711-00040#4 add
   #end add-point
...
{<section id="axcp950.transfer_argv" type="s" >}
...
{<section id="axcp950.process" type="s" >}
...
PRIVATE FUNCTION axcp950_process(ls_js)
  ...
  #END IF
   ...
   IF g_bgjob <> "Y" THEN
      ...
      LET g_flag = FALSE  #170302-00012#9   2017/03/14  By 08734 add
      #end add-point
   END IF
...
#  END FOREACH
   ...
   IF g_bgjob = "N" THEN
      ...
      #170302-00012#9   2017/03/14  By 08734 add(S)
      IF g_flag = FALSE THEN
         ...
         RETURN   
      END IF
      #170302-00012#9   2017/03/14  By 08734 add(E)
      #end add-point
...
{<section id="axcp950.get_buffer" type="s" >}
...
{<section id="axcp950.msgcentre_notify" type="s" >}
...
{<section id="axcp950.other_function" readonly="Y" type="s" >}

...
#該程式為freestyle程式!
{<section id="s_apmt500.description" type="s" >}
#應用 a00 樣板自動產生(Version:3)
#+ Standard Version.....: SD版次:0126(1900-01-01 00:00:00), PR版次:0126(2018-05-02 11:15:46)
#+ Customerized Version.: SD版次:0000(1900-01-01 00:00:00), PR版次:0000(1900-01-01 00:00:00)
#+ Build......: 000583
#+ Filename...: s_apmt500
#+ Description: 採購單維護作業相關元件
#+ Creator....: 02294(2013-12-23 11:27:29)
#+ Modifier...: 00000 -SD/PR- 07491
 
{</section>}
 
{<section id="s_apmt500.global" type="s" >}
...
#170330-00001#1   2017/04/10  By lixiang  如果是工單轉委外採購，委外採購單與工單單號相同，不允許委外採購作廢
#170322-00052#28  2017/05/02  By Mars     EC整合拋轉多加判斷參數 pmab112
#170511-00011#1   2017/05/11  By 08171    在寫bgbd時,bgbd013要取請購單的單身費用部門
#170515-00073#1   2017/05/18  By wuxja    计算最小套数时应考虑扣除仓退部分
#170329-00046#2   2017/05/18  By zhujing   单头总金额与单身总金额应一致，调整尾差
#170524-00010#1   2017/05/31  By wuxja    检查委外采购数量时需考虑作业编号作业序的条件
#170523-00006#1   2017/06/03  By catmoon  單價為0時，會造成l_j為0，但陣列由1開始，導致後續呼叫會使作業直接關閉
#170605-00038#1   2017/06/06  By lixiang  写入xrcd时，需传入当前画面上的汇率
#170522-00040#1   2017/06/08  By 08734    透過asft300工单转委外采购產生的結果和在apmt501直接輸入不同，以直接輸入為主。pmdl019，pmdl029
#170602-00075#1   2017/06/09  By zhujing  修正s_apmt500_get_pmdnamt()回传参数报错
#170525-00096#1   2017/06/12  By 07024    調整多期帳款金額的檢查，不開立發票，且類型為簽約金or訂金
#                                         符合  =>若為單價含稅，則"多期帳款總含稅金額"需等於"整張訂單的含稅金額"；未含稅反之
#                                         不符合=>"多期帳款總含稅金額/總稅前金額"需等於"整張訂單的含稅金額/稅前金額"
#170617-00149#1   2017/06/17  By 06137    v_ooeg001_2有使用到的錯誤訊息都改成有加上部門編號的錯誤訊息
#170617-00526#1   2017/06/17  By 06814    請購採購勾稽檢查數量時，需先做單位轉換
#170617-00541#1   2017/06/17  By 06814    若预先订单已经有转订单，则不可取消确认，排除作废订单
#170618-00419#1   2017/06/18  By lixiang  判断料件承认时，失效日期条件也要用大于等于
#170618-00035#1   2017/06/20  BY 08734    多交期资料中的最近更改时间要到具体的时间点
#170619-00082#1   2017/06/21  By 08734    訂單的签约金如果已立帳，不能再取消確認了
#170626-00043#1   2017/06/28  By 09042    預採購單已存在有效的採購單，不可取消確認
#170707-00024#1   2017/07/07  By ywtsai   修正170626-00043#1的空卡，僅預購採購單才需判斷控卡
#170710-00026#1   2017/07/10  By Whitney  修正170605-00038應考慮批次調用s_apmt500_get_amount()的情境
#170713-00030#1   2017/07/14  By Whitney  工單轉委外採購[聯絡人]獲取當前營運據點的聯絡對象識別碼
#170708-00002#1   2017/07/31  By lixiang  审核时检核交期明细是否存在资料，若不存在则会报错
#161227-00046#1   2017/08/04  By 08992    新增工單轉委外採購單時,生產數量都=本次轉委外量,需判斷是否1對1,採購單與工單單號一致
#170802-00017#1   2017/08/07  By 02111    asfp400 產生時的 apmt501 計價單位 pmdn010 與 pmdo030 必須一致。
#170809-00015#1   2017/08/10  By zhujing  产生订单时，应当传入作业编号axmt500  
#170821-00013#1   2017/08/23  By ouhz     调整请采勾稽差异处理方式设为拒绝，审核没卡控问题(修正170321-00041#1问题)
#170816-00043#1   2017/08/24  By Whitney  修正計算製程可轉委外數量
#170618-00068#3   2017/08/24  By 07024    新增s_apmt500_icae_chk，並在單據確認檢查段呼叫
#                                         (檢查付款條件、採購稅別、交易條件、發票類型是否與多角流程第0站設定相同，供應商是下一站據點的供應商)
#170816-00050#3   2017/08/29  By 07024    取消產生協作訂單的功能，註解s_apmt500_gen_order相關程式段落
#170909-00003#1   2017/09/11  By ouhz     调整s_apmt500_upd_pmdb049函数p_type长度定义导致传参错误问题
#170913-00008#1   2017/09/13  By liuym    管控多账期金额与单据金额时，用单头总金额比对
#170809-00006#2   2017/09/14  By 10046    (1)多角拋轉單據改成不檢查部門的法人設定 (2)修正匯率為空時，會寫成稅別的問題
#170920-00041#2   2017/09/22  By 07423    調整轉委外採購單時，預設納入APS計算為N(pmdl019)
#170815-00018#3   2017/10/05  By 08992    修正多期款不開立發票且全部訂金的狀況下，檢核多帳期金額是否與總金額合，僅檢查含稅部份
#170105-00050#7   2017/10/12  By 08992    1.修正採購單來源為預先訂單不檢查訂購數量
#                                         2.修正一般已轉訂單不能取消確認
#170816-00007#72  2017/10/27  By 09042   調整公用元件錯誤訊息,顯示更明確的資訊內容
#171024-00026#1   2017/10/30  By 02294   单身需求数量取位调整
#171116-00011#1   2017/11/23  By 00272   新增FUNCTION s_apmt500_maillist() COPY FROM 原apmt500.4gl內的apmt500_mallist()
#                                        以供後續多角代採產生最終站的一般PO也可以發送mail
#171128-00038#1   2017/11/29  by 09767   重复性工单产生采购单检查单据编号，以apmt503来检查
#171122-00032#1   2017/12/04  By 08993   修改將未稅金額、帳款未稅金額處理移除
#171205-00033#1   2017/12/11  By 09767   調整CKD組成用量總金額沒考慮組成用量問題
#170921-00009#2   2017/12/27  By 09042   产生交期明细档前，需要产生汇总档资料
#171214-00053#1   2017/12/28  By 09042   子件 特性代碼為9.樣品時不能更新apmi125(pmar_t)及aimm214的imai021.023.024.025
#171218-00022#1   2017/01/02  by 09767   若订单已产生一张收货单，则不予取消审核
#171214-00052#8   2018/01/11  by 09767   新增函数s_apmt500_adjust_amount()
#171206-00046#2   2018/01/25  By 10042   自動產生採購變更單資料
#171019-00015#81  2018/01/28  By 10046   訂單的出貨據點以單身出貨據點為主，若site欄位非key值，不過濾site條件
#170617-00078#3   2018/02/12  By 08993   1.將多角流程自動拋轉(E-BAS-0022)='Y'與還原移至sub
#                                        2.增加自動執行多角拋轉程式失敗後,顯示icer_t裡的多角拋轉詳細錯誤訊息
#180315-00004#1   2018/03/15  By 04441   委外採購帶多角流程代碼增加判斷是否為空
#180131-00013#2   2018/03/15  By 10046   多角流程編號(pmdl051)過欄位以及單據確認時，增加檢核供應商(pmdl021) 、送貨供應商(pmdl022)
#180320-00051#1   2018/03/20  By 07491   BPM簽核自動確認後，發送mail通知
#180402-00035#4   2018/04/02  By 02294   採購來源為請購單時，判斷是否存在pspo_t where pspo001=空白 and pspo002=空白 and pspo003=請購單單號+”-”+”請購項次
#171201-00014#1   2018/04/12  By 10042   修正訂單轉採購單，交期明細沒有產生附屬零件
#180424-00047#1   2018/04/25  By 07491   修正180320-00051#1，改用awsp302中介呼叫報表，解決報表未印BPM簽核歷程的問題
#end add-point
...
GLOBALS "../../cfg/top_report.inc"               #T100report的環境變數 #171116-00011#1 add
GLOBALS "../../cfg/top_schedule.inc"                                  #171116-00011#1 add
#end add-point
 
{</section>}
 
{<section id="s_apmt500.free_style_variable" type="s" >}
#add-point:free_style模組變數(Module Variable) name="free_style.variable"
#170816-00007#72 by 09042 add(S)
DEFINE g_colname_1   STRING   
DEFINE g_comment_1   STRING       
DEFINE g_msg         STRING   #錯誤訊息
#170816-00007#72 by 09042 add(E)
#end add-point
 
{</section>}
 
{<section id="s_apmt500.global_variable" type="s" >}
...
DEFINE g_ref_fields    DYNAMIC ARRAY OF VARCHAR(500) #ap_ref用陣列  #171116-00011#1 add
DEFINE g_rtn_fields    DYNAMIC ARRAY OF VARCHAR(500) #ap_ref用陣列  #171116-00011#1 add
END GLOBALS  #160726-00020#20 add
#end add-point
 
{</section>}
 
{<section id="s_apmt500.other_dialog" type="s" >}

 
{</section>}
 
{<section id="s_apmt500.other_function" readonly="Y" type="s" >}
################################################################################
...
DEFINE l_pmdn006       LIKE pmdn_t.pmdn006   #170617-00526#1 20170617 add by beckxie
#ming 20150904 add ---------------------------(S) 
...
DEFINE l_pmdl046       LIKE pmdl_t.pmdl046    #170525-00096#1-add
DEFINE l_pmdp022       LIKE pmdp_t.pmdp022    #170617-00526#1 20170617 add by beckxie 
DEFINE l_pmdp023_old   LIKE pmdp_t.pmdp023    #170617-00526#1 20170617 add by beckxie
DEFINE l_pmdp023_new   LIKE pmdp_t.pmdp023    #170617-00526#1 20170617 add by beckxie
DEFINE l_sql           STRING
#170809-00006#2 add --s
DEFINE l_pmdl006       LIKE pmdl_t.pmdl006
DEFINE l_pmdl030       LIKE pmdl_t.pmdl030
#170809-00006#2 add --e
DEFINE l_cnt           LIKE type_t.num5       #170809-00006#2 add
   ...
   LET l_pmdl030  = ''
   #170809-00006#2 add --e
  #SELECT pmdlstus INTO l_pmdlstus FROM pmdl_t   #170809-00006#2  mark
   SELECT pmdlstus, pmdl006, pmdl030 INTO l_pmdlstus, l_pmdl006, l_pmdl030 FROM pmdl_t   #170809-00006#2 add
   ...
   SELECT pmdl002,pmdl003,pmdldocdt,pmdl017,pmdl004,
          ...
          ,pmdl013,pmdl046  #170525-00096#1-add
     INTO l_pmdl002,l_pmdl003,l_pmdldocdt,l_pmdl017,l_pmdl004,
          l_pmdl051 #150917-00001#4 151124 earl add
          ,l_pmdl013,l_pmdl046 #170525-00096#1-add
     FROM pmdl_t 
    WHERE pmdlent = g_enterprise AND pmdldocno = p_pmdldocno
    #170809-00006#2 add --s
    SELECT COUNT(1) INTO l_cnt FROM icab_t
     WHERE icabent = g_enterprise AND icab001 = l_pmdl051 AND icab003 = g_site
       AND icab002 = (SELECT MAX(icab002) FROM icab_t
                       WHERE icabent = g_enterprise AND icab001 = l_pmdl051)
    #170809-00006#2 add --e
   ...
   IF NOT cl_null(l_pmdl003) THEN 
      ...
      #170809-00006#2 add --s 
      IF (l_pmdl006 = "6" AND l_pmdl030 = "Y") OR (l_pmdl006 = "1" AND l_pmdl030 = "Y" AND l_cnt > 0) THEN
         LET g_chkparam.err_str[1] = "aoo-00029:sub-01302|aooi125|",cl_get_progname("aooi125",g_lang,"2"),"|:EXEPROGaooi125"
         LET g_chkparam.err_str[2] = "aoo-00008:sub-01455|",l_pmdl003,"|''|:EXEPROGaooi125"
         LET g_chkparam.err_str[3] = "aoo-00201:sub-01456|",l_pmdl003,"|''|:EXEPROGaooi125"    
      ...
      ELSE
      #170809-00006#2 add --e
         LET g_chkparam.err_str[1] = "aoo-00201:sub-01456|",l_pmdl003,"|''|:EXEPROGaooi125"    #170617-00149#1 Add By Ken 170617     
         #呼叫檢查存在並帶值的library
         #170809-00006#2  mark --s
         #IF cl_chk_exist("v_ooeg001_2") THEN
         #   #檢查成功時後續處理
         #ELSE
         #   #檢查失敗時後續處理
         #170809-00006#2  mark --e
         #170809-00006#2   add --s
         LET g_chkparam.err_str[2] = "aoo-00029:sub-01302|aooi125|",cl_get_progname("aooi125",g_lang,"2"),"|:EXEPROGaooi125"
         LET g_chkparam.err_str[3] = "sub-01397:sub-01454|",l_pmdl003,"|''|:EXEPROGaooi125"
         LET g_chkparam.err_str[4] = "aoo-00008:sub-01455|",l_pmdl003,"|''|:EXEPROGaooi125"
         IF NOT cl_chk_exist("v_ooeg001") THEN
         #170809-00006#2   add --e
            LET r_success = FALSE
            RETURN r_success
         END IF 
      END IF   #170809-00006#2 add
   ELSE
      #申請部門未輸入！
      INITIALIZE g_errparam TO NULL
   ...
   #170708-00002#1---add--s
   LET l_n = 0
   SELECT COUNT(*) INTO l_n FROM pmdo_t WHERE pmdoent = g_enterprise AND pmdodocno = p_pmdldocno
   IF l_n = 0 OR l_n IS NULL THEN
      #交期明细中尚未有任何资料，不可進行確認
      INITIALIZE g_errparam TO NULL
      ...
      RETURN r_success
   END IF
   #170708-00002#1---add--e
   
   #add by wanghaoz 2017/07/13 170710-00037#1 不经过采购数量栏位也进行栏位检查进行控管-----(s)
   LET l_i = 0
   SELECT COUNT(*) INTO l_i FROM pmdn_t WHERE pmdn007 <= 0 AND pmdnent = g_enterprise AND pmdndocno = p_pmdldocno 
   IF l_i > 0 THEN
      INITIALIZE g_errparam TO NULL
      ...
      RETURN r_success
   END IF
   #add by wanghaoz 2017/07/13 170710-00037#1 不经过采购数量栏位也进行栏位检查进行控管-----(e)   
   ...
   #170618-00068#2-s-add
   IF NOT s_apmt500_icae_chk(p_pmdldocno,l_pmdl051) THEN
      LET r_success = FALSE
      RETURN r_success 
   END IF
   #170618-00068#2-e-add
   ...
   #最大容差率
   LET l_rate = cl_get_doc_para(g_enterprise,g_site,l_slip,'D-BAS-0085') #170821-00013#1 mod  l_slip to l_ooba002
   #161205-00025#2---e      
   ...
   #170617-00526#1 20170617 add by beckxie---S
   LET l_sql = " SELECT pmdp022,SUM(pmdp023) ", 
               "   FROM pmdp_t ",
               "  WHERE pmdpent   = ",g_enterprise,
               "    AND pmdpdocno = '",p_pmdldocno,"' ",
               "    AND pmdpseq   = ? ",
               "  GROUP BY pmdp022 " 
   PREPARE s_apmt500_sum_pmdp023_pre FROM l_sql
   DECLARE s_apmt500_sum_pmdp023_cs CURSOR FOR s_apmt500_sum_pmdp023_pre
   #170617-00526#1 20170617 add by beckxie---E
   ...
   DECLARE pmdn_cur CURSOR FOR SELECT pmdnseq,pmdn007,pmdn015,pmdn019,
                                      ...
                                      #pmdn058                        #170617-00526#1 20170617 mark by beckxie
                                      pmdn058,pmdn006                 #170617-00526#1 20170617 add by beckxie
                                 FROM pmdn_t
   ...
   FOREACH pmdn_cur INTO l_pmdnseq,l_pmdn007,l_pmdn015,l_pmdn019,
                         ...
                         #l_pmdn058            #170617-00526#1 20170617 mark by beckxie
                         l_pmdn058,l_pmdn006   #170617-00526#1 20170617 add by beckxie
   #ming 20150903 modify -----------------------------(E) 
...
#         SELECT SUM(pmdp024) INTO l_sum_pmdp023     #170111-00026#7 mark
         #170617-00526#1 20170617 mark by beckxie---S
         #SELECT SUM(pmdp023) INTO l_sum_pmdp023      #170111-00026#7 add
         #  FROM pmdp_t
         # WHERE pmdpent   = g_enterprise
         #   AND pmdpdocno = p_pmdldocno
         #   AND pmdpseq   = l_pmdnseq
         #170617-00526#1 20170617 mark by beckxie---E
         #170617-00526#1 20170617 add by beckxie---S
         LET l_pmdp022 = ''
         LET l_pmdp023_old = 0
         LET l_pmdp023_new = 0
         LET l_sum_pmdp023 = 0
         #每個單位轉換數量後加總，再進行比較
         FOREACH s_apmt500_sum_pmdp023_cs USING l_pmdnseq INTO l_pmdp022,l_pmdp023_old
            
            LET l_success = ''
            CALL s_aooi250_convert_qty(l_pmdn001,l_pmdp022,l_pmdn006,l_pmdp023_old)
            RETURNING l_success,l_pmdp023_new
            
            LET l_sum_pmdp023 = l_sum_pmdp023 + l_pmdp023_new
   ...
   IF l_n > 0 THEN
#     SELECT SUM(pmdm005),SUM(pmdm006) INTO l_pmdm005,l_pmdm006 FROM pmdm_t   #171122-00032#1 mark
      SELECT SUM(pmdm006) INTO l_pmdm006 FROM pmdm_t                          #171122-00032#1 add
        WHERE pmdment = g_enterprise AND pmdmdocno = p_pmdldocno
      #170913-00008#1 mark----s----
      #SELECT SUM(pmdn046),SUM(pmdn047) INTO l_pmdn046,l_pmdn047 FROM pmdn_t
      #  WHERE pmdnent = g_enterprise AND pmdndocno = p_pmdldocno
      #170913-00008#1 mark----e----
      #170913-00008#1 add----s----
      SELECT pmdl040,pmdl041 INTO l_pmdn046,l_pmdn047 FROM pmdl_t
        WHERE pmdlent = g_enterprise AND pmdldocno = p_pmdldocno
      #170913-00008#1 add----s----
      #SELECT pmdl013 INTO l_pmdl013 FROM pmdl_t WHERE pmdlent = g_enterprise AND pmdldocno = p_pmdldocno 170525-00096-mark 移至上面一起SELECT
      #170525-00096#1-s-mark
      ...
      ##170120-00035#1-e
      #END IF
      #170525-00096#1-e-mark
      #170525-00096#1-s-add
      #170815-00018#3-s add
      #取得不等於訂金的筆數
      LET l_cnt = 0
      SELECT COUNT(1) INTO l_cnt
        FROM pmdm_t
       WHERE pmdment = g_enterprise      AND pmdmdocno = p_pmdldocno
         AND pmdm014 NOT IN ('1','2')
       #171122-00032#1-s mark  
#      #170815-00018#3-e add         
#      IF l_pmdl046 = '1' THEN
#         #含稅時，比較整張單據的含稅金額，未稅時，比較未稅總金額
#        #IF l_pmdl013 = 'Y' THEN                                      #170815-00018#3 mark
#         IF l_pmdl013 = 'Y' OR (l_pmdl046 = '1' AND l_cnt = 0) THEN   #170815-00018#3 add
#            IF l_pmdm006 <> l_pmdn047 THEN
#               INITIALIZE g_errparam TO NULL
#               LET g_errparam.code = 'apm-00588'
#               LET g_errparam.extend = p_pmdldocno
...
#         END IF
#      ELSE
#         IF (l_pmdm005 <> l_pmdn046) OR (l_pmdm006 <> l_pmdn047) THEN
#            INITIALIZE g_errparam TO NULL
#            LET g_errparam.code = 'apm-01181'  #多期預付款含稅/未稅總金額需與整張採購單含稅/未稅金額一致！
#            LET g_errparam.extend = p_pmdldocno
#            LET g_errparam.popup = TRUE
#            CALL cl_err()
#          
...
#         END IF
#      END IF
#      #170525-00096#1-e-add
       #171122-00032#1-e mark
       #171122-00032#1-s add
       IF l_pmdm006 <> l_pmdn047 THEN
          INITIALIZE g_errparam TO NULL
          LET g_errparam.code = 'apm-00588'
          LET g_errparam.extend = p_pmdldocno
...
DEFINE l_cnt2          LIKE type_t.num5     #170322-00052#28 
#170329-00046#2-S
...
#170329-00046#2-E
   ...
   #170329-00046#2 add-S   尾差处理
   CALL s_apmt500_chk_pmdn016(p_pmdldocno) RETURNING l_success
   IF l_success THEN
      #交易稅總額重計
      CALL s_tax_recount(p_pmdldocno) RETURNING l_pmdl040,l_pmdl042,l_pmdl041,l_xrcd113,l_xrcd114,l_xrcd115
      ...
      IF SQLCA.sqlcode THEN
         INITIALIZE g_errparam TO NULL
         LET g_errparam.code = SQLCA.sqlcode
         LET g_errparam.extend = "UPDATE pmdl_t2"
         LET g_errparam.popup = TRUE
         CALL cl_err()
         LET r_success = FALSE
      END IF 
      #調整尾差
      IF NOT s_apmt500_adjust_tax(p_pmdldocno) THEN
         LET r_success = FALSE
      END IF       
   END IF 
   #170329-00046#2 add-E
...
#      END IF
      ...
      IF l_pmdn.pmdn019 <> '9' THEN   #171214-00053#1 add pmdn019不能为9的条件
         IF l_cnt > 0 THEN  
            UPDATE pmar_t
      ...
      IF l_pmdn.pmdn019 <> '9' THEN  #171214-00053#1 add
      ...
      #171214-00053#1 add(s)
      ELSE
         UPDATE imai_t SET imai035 = l_pmdldocdt,imai101 = l_pmdldocdt,imai102 = p_pmdldocno
            WHERE imaient = g_enterprise AND imaisite = g_site AND imai001 = l_pmdn.pmdn001
      END IF
      #171214-00053#1 add(e)
      IF SQLCA.sqlcode THEN
         LET r_success = FALSE
         INITIALIZE g_errparam TO NULL
         LET g_errparam.code = SQLCA.sqlcode
   ...
   IF cl_get_para(g_enterprise,g_site,"S-SYS-0006") = "Y" THEN                      
      #170322-00052#28 add - str -
      SELECT COUNT(1) INTO l_cnt2
        FROM pmdl_t,pmab_t
       WHERE pmdlent = pmabent
         AND pmdl004 = pmab001 
         AND pmabsite = g_site
         AND pmdlent = g_enterprise
         AND pmab112 = 'Y'
         AND pmdldocno = p_pmdldocno
      #170322-00052#28 add - end -
      ...
      IF l_cnt2 > 0 THEN   #170322-00052#28 add
         #拋轉 採購單開立 給EC
         CALL s_all_wsel('','EBCHAIN','purchase.create',p_pmdldocno,'','','','','','','','','') RETURNING r_success #add by Nina
         #CALL s_jscli_ec01('',p_pmdldocno) RETURNING l_success  #mark by Nina
         IF NOT r_success THEN  
            RETURN r_success
         END IF
      END IF               #170322-00052#28 add
   END IF
...
DEFINE l_pmdlstus        LIKE pmdl_t.pmdlstus
DEFINE l_n               LIKE type_t.num5
DEFINE l_n2              LIKE type_t.num5   #170105-00050#7 add
DEFINE r_success         LIKE type_t.num5 
DEFINE l_pmdl007         LIKE pmdl_t.pmdl007
DEFINE l_pmdl008         LIKE pmdl_t.pmdl008  #170617-00541#1 20170617 add by beckxie
DEFINE l_pmdl031         LIKE pmdl_t.pmdl031
DEFINE l_pmdl057         LIKE pmdl_t.pmdl057  #170322-00052#2 add
DEFINE l_pmdl005         LIKE pmdl_t.pmdl005  #170707-00024#1 add
   ...
   LET l_pmdlstus = ''
   LET l_pmdl007 = ''
   #170617-00541#1 20170617 modify(add pmdl008) by beckxie---S
   #SELECT pmdlstus,pmdl007,pmdl008,pmdl031 INTO l_pmdlstus,l_pmdl007,l_pmdl008,l_pmdl031 FROM pmdl_t                    #170707-00024#1 mark
   SELECT pmdlstus,pmdl005,pmdl007,pmdl008,pmdl031 INTO l_pmdlstus,l_pmdl005,l_pmdl007,l_pmdl008,l_pmdl031 FROM pmdl_t   #170707-00024#1 add
   #170617-00541#1 20170617 modify(add pmdl008) by beckxie---E   
      WHERE pmdlent = g_enterprise AND pmdldocno = p_pmdldocno
   ...
   IF l_pmdl005 = '4' THEN     #170707-00024#1 add 預先採購單
      LET l_n = 0
      #SELECT COUNT(*) INTO l_n FROM pmdl    #170626-00043#1 mark
      SELECT COUNT(*) INTO l_n FROM pmdl_t   #170626-00043#1 add
      ...
      IF l_n > 0 THEN
         ...
         RETURN r_success
      END IF
   END IF                      #170707-00024#1 add
   
   #若採購單已經有轉有效的收貨單，有則不允許取消確認成功，錯誤訊息「已轉收貨單，不可做取消確認」
   #171218-00022#1 add by 09767-->s
   #若单头有资料，单身无资料
   LET l_n = 0
   SELECT COUNT(*) INTO l_n FROM pmds_t
     WHERE pmdsent = g_enterprise AND pmds006 = p_pmdldocno AND pmdsstus != 'X'
   ...
   SELECT COUNT(*) INTO l_n
    ...
    WHERE pmdment = g_enterprise
      ...
      #AND pmdm014 = '2'  #170619-00082#1 mark
      AND (pmdm014='1' OR pmdm014='2')   #170619-00082#1 add    
      AND pmdm007 IS NOT NULL
   IF l_n > 0 THEN
      INITIALIZE g_errparam TO NULL
      #LET g_errparam.code = 'axm-00736'  #170619-00082#1 mark
      LET g_errparam.code = 'axm-00843'  #170619-00082#1 add
      LET g_errparam.extend = p_pmdldocno
      LET g_errparam.popup = TRUE
      CALL cl_err()
      LET r_success = FALSE
   ...
   #170105-00050#7-s mark     
#   #170617-00541#1 20170617 add by beckxie---S
#   #若预先订单已经有转订单，则不可取消确认，排除作废订单
#   IF l_pmdl007 = '8' THEN   
#     LET l_n = 0    
#     SELECT COUNT(1) INTO  l_n FROM pmdl_t 
#      WHERE pmdlent = g_enterprise 
#       AND pmdldocno = l_pmdl008   
#       AND pmdlstus <> 'X'        
#     IF l_n > 0 THEN
#       INITIALIZE g_errparam TO NULL
#       LET g_errparam.code = 'apm-08344'
#       LET g_errparam.extend = p_pmdldocno
#       LET g_errparam.popup = TRUE
#       CALL cl_err()
#       LET r_success = FALSE
#     END IF      
#   END IF
#   #170617-00541#1 20170617 add by beckxie---E
   #170105-00050#7-e mark     
   #170322-00052#2 add - str -
   #判斷 aoos020 是否啟用 e-B Chain 整合
   IF cl_get_para(g_enterprise,g_site,"S-SYS-0006") = "Y" THEN
      ...
      SELECT pmdl057 INTO l_pmdl057
       ...
       WHERE pmdldocno = p_pmdldocno
         AND pmdlent = g_enterprise
         #AND pmdlsite = g_site   #171019-00015#81 mark   
...
#      SELECT * FROM pmdn_t WHERE pmdnent = g_enterprise AND pmdndocno = p_pmdldocno
   ...
   IF SQLCA.sqlcode THEN
      ...
      RETURN r_success
   END IF
   #171214-00052#8 mark by 09767-->s   
   ##170329-00046#2 add-S   尾差处理
   #CALL s_apmt500_chk_pmdn016(p_pmdldocno) RETURNING l_success
   #IF l_success THEN
   #   #交易稅總額重計
   #   CALL s_apmt500_unconf_xrcd(p_pmdldocno)     #将分摊结果还原
   #      RETURNING l_success
   #   IF NOT l_success THEN
   #      LET r_success = FALSE
   #      RETURN r_success
   ...
   #END IF 
   ##170329-00046#2 add-E
   #171214-00052#8 mark by 09767-->e
...
DEFINE l_pmdl007         LIKE pmdl_t.pmdl007  #170330-00001#1 add
DEFINE l_pmdl008         LIKE pmdl_t.pmdl008  #170330-00001#1 add
   ...
   LET l_pmdl007 = ''   #170330-00001#1 add
   LET l_pmdl008 = ''   #170330-00001#1 add
   SELECT pmdlstus,pmdl056,pmdl007,pmdl008 INTO l_pmdlstus,l_pmdl056,l_pmdl007,l_pmdl008  #170214-00015#4 add pmdl056  #170330-00001#1 add pmdl007,mdl008
       FROM pmdl_t  
      WHERE pmdlent = g_enterprise AND pmdldocno = p_pmdldocno
   IF l_pmdlstus = 'Y' THEN
      #此筆資料已經確認;請確認狀態碼!
   ...
   #170330-00001#1---s
   #此委外採購單是由工單轉入，且與工單單號相同，不允許作廢
   IF p_pmdldocno = l_pmdl008 AND l_pmdl007 = '4' THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.code = 'apm-01165'
      LET g_errparam.extend = p_pmdldocno
      LET g_errparam.popup = TRUE
      CALL cl_err()
      LET r_success = FALSE
...
#171205-00033#1 add by 09767-->s
DEFINE l_pmdn046       LIKE pmdn_t.pmdn046 
DEFINE l_pmdn047       LIKE pmdn_t.pmdn047
DEFINE l_pmdn048       LIKE pmdn_t.pmdn048  
DEFINE l_pmdo032_s     LIKE pmdo_t.pmdo032     
DEFINE l_pmdo032_m     LIKE pmdo_t.pmdo032    
DEFINE l_pmdo032_u     LIKE pmdo_t.pmdo032
DEFINE l_pmdo033_s     LIKE pmdo_t.pmdo033     
DEFINE l_pmdo033_m     LIKE pmdo_t.pmdo033    
DEFINE l_pmdo033_u     LIKE pmdo_t.pmdo033
DEFINE l_pmdo034_s     LIKE pmdo_t.pmdo034     
DEFINE l_pmdo034_m     LIKE pmdo_t.pmdo034    
DEFINE l_pmdo034_u     LIKE pmdo_t.pmdo034
DEFINE l_pmdoseq1      LIKE pmdo_t.pmdoseq1
DEFINE l_pmdoseq2      LIKE pmdo_t.pmdoseq2
#171205-00033#1 add by 09767-->e
       ...
       SELECT pmdl015,pmdl016,pmdl054,pmdn001,pmdn002,
              ...
              ,pmdn046,pmdn047,pmdn048                       #171205-00033#1 add   by 09767
         INTO g_pmdl015,g_pmdl016,l_pmdl054,l_pmdn001,l_pmdn002,
              ...
              ,l_pmdn046,l_pmdn047,l_pmdn048                       #171205-00033#1 add   by 09767
         FROM pmdl_t,pmdn_t
       ...
       IF l_pmdn019 MATCHES '[23]' THEN
          ...
          IF cl_get_para(g_enterprise,g_site,'S-BAS-0022') = '1' THEN
             ...
             FOR l_i = 1 TO g_bmba.getLength()             
                 ...
                 IF l_success THEN
                    #LET l_total = l_total + l_pmdo022         #171205-00033#1 mark by 09767
                    LET l_total = l_total + l_pmdo022*(g_bmba[l_i].l_bmba011/g_bmba[l_i].l_bmba012)   #171205-00033#1 modify by 09767
                 ELSE
                    LET r_success = FALSE
                    RETURN r_success                
                 END IF
       ...
       #171205-00033#1 add by 09767-->s
       #子件特性為'2:CKD'或是'3SKD'時,若分攤金額有尾差時,攤到金額最大筆資料
       IF l_pmdn019 MATCHES '[23]' THEN
          SELECT SUM(pmdo032),SUM(pmdo033),SUM(pmdo034)
            INTO l_pmdo032_s,l_pmdo033_s,l_pmdo034_s 
            FROM pmdo_t
           WHERE pmdoent = g_enterprise 
             #AND pmdosite = g_site   #171019-00015#81 mark
             AND pmdodocno = p_pmdodocno
             AND pmdoseq = p_pmdoseq             
             
          IF l_pmdo032_s <> l_pmdn046 OR l_pmdo033_s <> l_pmdn047 OR l_pmdo034_s <> l_pmdn048 THEN
          
             SELECT pmdoseq1,pmdoseq2,pmdo032,pmdo033,pmdo034 
               INTO l_pmdoseq1,l_pmdoseq2,l_pmdo032_m,l_pmdo033_m,l_pmdo034_m
               FROM pmdo_t
              WHERE pmdoent = g_enterprise 
                #AND pmdosite = g_site   #171019-00015#81 mark
                AND pmdodocno = p_pmdodocno
                AND pmdoseq = p_pmdoseq
              ORDER By pmdo032 DESC               
        
             LET l_pmdo032_u = l_pmdo032_m + (l_pmdn046 - l_pmdo032_s)
             LET l_pmdo033_u = l_pmdo033_m + (l_pmdn047 - l_pmdo033_s)
             LET l_pmdo034_u = l_pmdo034_m + (l_pmdn048 - l_pmdo034_s)
            
             UPDATE pmdo_t
                SET pmdo032 = l_pmdo032_u,
                    pmdo033 = l_pmdo033_u,
                    pmdo034 = l_pmdo034_u
              WHERE pmdoent = g_enterprise 
                #AND pmdosite = g_site   #171019-00015#81 mark
...
#       SELECT * INTO l_pmdn.* FROM pmdn_t WHERE pmdnent = g_enterprise AND pmdndocno = p_pmdodocno AND pmdnseq = p_pmdoseq
       ...
       #LET l_pmdo.pmdo027 = g_today         #最近修改日  #170618-00035#1  mark  
       LET l_pmdo.pmdo027 = cl_get_current()         #最近修改日  #170618-00035#1    add
       ...
       #171201-00014#1 -S add
       #判斷是否有附屬零件，如有，需重新產生至交期明細中
       INITIALIZE l_xmdq.* TO NULL
       
       LET l_pmdl007 = ''
       LET l_pmdl008 = ''
       SELECT pmdl007,pmdl008
         INTO l_pmdl007,l_pmdl008
         FROM pmdl_t
        WHERE pmdlent = g_enterprise
          AND pmdldocno = p_pmdodocno
       LET l_cnt = 0
       IF l_pmdl007 = '3' THEN   
          SELECT COUNT(1) INTO l_cnt
            FROM xmdq_t
           WHERE xmdqent = g_enterprise
             AND xmdqdocno = l_pmdl008
             AND xmdqseq = p_pmdoseq
             AND xmdq002 = l_pmdn.pmdn001
          
          IF l_cnt > 0 THEN
             DECLARE s_apmt500_xmdq_cs1 CURSOR FOR
             SELECT DISTINCT xmdqseq,xmdqseq1,xmdq001,xmdq002,xmdq003,xmdq004,xmdq005,xmdq006,xmdq007,xmdq008,xmdq009,xmdq010,xmdq011,xmdq012
             FROM xmdq_t
            WHERE xmdqent = g_enterprise       
              AND xmdqdocno = l_pmdl008 
              AND xmdqseq = p_pmdoseq
              AND xmdq012 = '5'    
              ORDER BY xmdqseq,xmdqseq1      
            
             FOREACH s_apmt500_xmdq_cs1 INTO l_xmdq.xmdqseq,l_xmdq.xmdqseq1,l_xmdq.xmdq001,l_xmdq.xmdq002,l_xmdq.xmdq003,l_xmdq.xmdq004,
                                             l_xmdq.xmdq005,l_xmdq.xmdq006,l_xmdq.xmdq007,l_xmdq.xmdq008,l_xmdq.xmdq009,
                                             l_xmdq.xmdq010,l_xmdq.xmdq011,l_xmdq.xmdq012
                LET l_pmdo.pmdoseq1 = ''
                SELECT MAX(pmdoseq1) + 1 
                  INTO l_pmdo.pmdoseq1 
                  FROM pmdo_t
                 WHERE pmdoent =  g_enterprise
                   AND pmdodocno = p_pmdodocno
                   AND pmdoseq = p_pmdoseq
                ...
                SELECT xmdc007 INTO l_xmdq.xmdq009 
                  FROM xmdc_t
                 WHERE xmdcent = g_enterprise 
                   AND xmdcdocno = l_pmdl008 
                   AND xmdcseq = p_pmdoseq
                     
                LET l_xmdq.xmdq009 = l_xmdq.xmdq009 * l_xmdq.xmdq006 / l_xmdq.xmdq007  
                #多交期明細中子件特性為附屬零件的稅別/計價單位/計價數量/稅率給值
                LET l_imaf113 = ''
                SELECT imaf113 INTO l_imaf113 FROM imaf_t
                  WHERE imafent = g_enterprise
                    AND imafsite = g_site
                    AND imaf001= l_xmdq.xmdq001
                IF cl_get_para(g_enterprise,g_site,'S-BAS-0007') = 'N' THEN
                 LET l_pmdo.pmdo030 = l_xmdq.xmdq008
                 LET l_pmdo.pmdo031 = l_xmdq.xmdq009
                ELSE
                  IF cl_null(l_imaf113) THEN
                    LET l_pmdo.pmdo030 = l_xmdq.xmdq008
                    LET l_pmdo.pmdo031 = l_xmdq.xmdq009
                  ELSE
                    LET l_pmdo.pmdo030 = l_imaf113
                    CALL s_aooi250_convert_qty(l_xmdq.xmdq001,l_xmdq.xmdq008,l_pmdo.pmdo030,l_xmdq.xmdq009)
                ...
                LET l_imaf015 = ''
                SELECT imaf015 INTO l_imaf015 FROM imaf_t WHERE imafent = g_enterprise AND imafsite = g_site AND imaf001 = l_xmdq.xmdq001    
                
                LET l_pmdo.pmdo029 = 0
                IF NOT cl_null(l_xmdq.xmdq008) AND NOT cl_null(l_imaf015) THEN
                   CALL s_aooi250_convert_qty(l_xmdq.xmdq001,l_xmdq.xmdq008,l_imaf015,l_xmdq.xmdq009)
                     RETURNING l_success,l_pmdo.pmdo029
                   #參考數量取位
                   CALL s_aooi250_take_decimals(l_imaf015,l_pmdo.pmdo029)
                     RETURNING l_success,l_pmdo.pmdo029                 
                END IF 
                ...
                INSERT INTO pmdo_t
                        (pmdoent,pmdodocno,pmdoseq,pmdoseq1,pmdoseq2,pmdosite,pmdo001,pmdo002,pmdo003,pmdo004,
                         ...
                         pmdo041,pmdo042,pmdo043,pmdo044)  
                 VALUES (g_enterprise,l_pmdo.pmdodocno,l_pmdo.pmdoseq,l_pmdo.pmdoseq1,l_pmdo.pmdoseq2,l_pmdo.pmdosite,
                         l_xmdq.xmdq001,l_pmdo.pmdo002,'5',l_xmdq.xmdq008,l_xmdq.xmdq009,l_xmdq.xmdq009,l_pmdo.pmdo007,
                         l_pmdo.pmdo008,l_pmdo.pmdo009,l_pmdo.pmdo010,l_pmdo.pmdo011,l_pmdo.pmdo012,l_pmdo.pmdo013,l_pmdo.pmdo014,
                         l_pmdo.pmdo015,l_pmdo.pmdo016,l_pmdo.pmdo017,l_pmdo.pmdo019,l_pmdo.pmdo020,l_pmdo.pmdo021,
                         l_pmdo.pmdo022,l_pmdo.pmdo023,l_pmdo.pmdo024,'',l_pmdo.pmdo026,l_pmdo.pmdo027,l_imaf015,
                         l_pmdo.pmdo029,l_pmdo.pmdo030,l_pmdo.pmdo031,l_pmdo.pmdo032,l_pmdo.pmdo033,l_pmdo.pmdo034,l_pmdo.pmdo040,
                         l_pmdo.pmdo041,l_pmdo.pmdo042,l_pmdo.pmdo043,l_pmdo.pmdo044)
                IF SQLCA.sqlcode THEN
                   INITIALIZE g_errparam TO NULL
...
#       SELECT * INTO l_pmdn.* FROM pmdn_t WHERE pmdnent = g_enterprise AND pmdndocno = p_pmdodocno AND pmdnseq = p_pmdoseq
       ...
       FOR l_i = 1 TO g_bmba.getLength()
           ...
           IF l_pmdl007 = '3' THEN   
              ...
              IF l_cnt > 0 THEN
                 DECLARE s_apmt500_xmdq_cs2 CURSOR FOR
                 SELECT DISTINCT xmdqseq,xmdqseq1,xmdq001,xmdq002,xmdq003,xmdq004,xmdq005,xmdq006,xmdq007,xmdq008,xmdq009,xmdq010,xmdq011,xmdq012
                 FROM xmdq_t
                WHERE xmdqent = g_enterprise       
                  AND xmdqdocno = l_pmdl008 
                 ...
                 FOREACH s_apmt500_xmdq_cs2 INTO l_xmdq.xmdqseq,l_xmdq.xmdqseq1,l_xmdq.xmdq001,l_xmdq.xmdq002,l_xmdq.xmdq003,l_xmdq.xmdq004,
                                                 l_xmdq.xmdq005,l_xmdq.xmdq006,l_xmdq.xmdq007,l_xmdq.xmdq008,l_xmdq.xmdq009,
                                                 l_xmdq.xmdq010,l_xmdq.xmdq011,l_xmdq.xmdq012
                    LET l_pmdo.pmdoseq1 = ''
                    SELECT MAX(pmdoseq1) + 1 
...
#          SELECT * FROM pmdq_t WHERE pmdqent = g_enterprise AND pmdqdocno = p_pmdodocno AND pmdqseq = p_pmdoseq
       ...
       IF l_pmdl007 = '3' THEN   
          ...
          IF l_cnt > 0 THEN
             DECLARE s_apmt500_xmdq_cs3 CURSOR FOR
             SELECT DISTINCT xmdqseq,xmdqseq1,xmdq001,xmdq002,xmdq003,xmdq004,xmdq005,xmdq006,xmdq007,xmdq008,xmdq009,xmdq010,xmdq011,xmdq012
             FROM xmdq_t
            WHERE xmdqent = g_enterprise       
              AND xmdqdocno = l_pmdl008 
             ...
             FOREACH s_apmt500_xmdq_cs3 INTO l_xmdq.xmdqseq,l_xmdq.xmdqseq1,l_xmdq.xmdq001,l_xmdq.xmdq002,l_xmdq.xmdq003,l_xmdq.xmdq004,
                                             l_xmdq.xmdq005,l_xmdq.xmdq006,l_xmdq.xmdq007,l_xmdq.xmdq008,l_xmdq.xmdq009,
                                             l_xmdq.xmdq010,l_xmdq.xmdq011,l_xmdq.xmdq012
                LET l_pmdo.pmdoseq1 = ''
                SELECT MAX(pmdoseq1) + 1 
       ...
       FOREACH pmdq_cs2 INTO l_pmdq.* 
          ...
          FOR l_i = 1 TO g_bmba.getLength()
             ...
             IF l_pmdl007 = '3' THEN   
                ...
                IF l_cnt > 0 THEN
                   DECLARE s_apmt500_xmdq_cs4 CURSOR FOR
                   SELECT DISTINCT xmdqseq,xmdqseq1,xmdq001,xmdq002,xmdq003,xmdq004,xmdq005,xmdq006,xmdq007,xmdq008,xmdq009,xmdq010,xmdq011,xmdq012
                   FROM xmdq_t
                  WHERE xmdqent = g_enterprise       
                    AND xmdqdocno = l_pmdl008 
                   ...
                   FOREACH s_apmt500_xmdq_cs4 INTO l_xmdq.xmdqseq,l_xmdq.xmdqseq1,l_xmdq.xmdq001,l_xmdq.xmdq002,l_xmdq.xmdq003,l_xmdq.xmdq004,
                                                   l_xmdq.xmdq005,l_xmdq.xmdq006,l_xmdq.xmdq007,l_xmdq.xmdq008,l_xmdq.xmdq009,
                                                   l_xmdq.xmdq010,l_xmdq.xmdq011,l_xmdq.xmdq012
                      LET l_pmdo.pmdoseq1 = ''
                      SELECT MAX(pmdoseq1) + 1 
...
DEFINE l_seq1         LIKE type_t.num20_6
       ...
       SELECT MIN(a) 
         INTO l_seq1 
        #FROM (SELECT SUM((pmdo015-pmdo016) /pmdo008) a              #170515-00073#1 mark
         FROM (SELECT SUM((pmdo015-pmdo016-pmdo017) /pmdo008) a      #170515-00073#1 add        
                 FROM pmdo_t
                WHERE pmdoent = g_enterprise
                  AND pmdodocno = p_pmdodocno
                  AND pmdoseq = p_pmdoseq
...
PUBLIC FUNCTION s_apmt500_gen(p_type,p_key1,p_key2,p_doc_type,p_date,p_combine)
   ...
   #170816-00007#72 by 09042 mark(S)
   ...
   #END IF
   #170816-00007#72 by 09042 mark(E)
   #170816-00007#72 by 09042 add(S)
   ...
   IF cl_null(p_type) THEN
      LET g_colname_1 = ''
      LET g_comment_1 = ''   
      CALL s_azzi902_get_gzzd("asft800","lbl_sfkb001") RETURNING g_colname_1,g_comment_1  #；来源类型
...
DEFINE l_pmdl016         LIKE pmdl_t.pmdl016  #170605-00038#1 add
   ...
   IF cl_null(l_pmdl016) THEN
     #LET l_pmdl016 = p_pmdn016   #170809-00006#2 mark
      LET l_pmdl016 = 1           #170809-00006#2  add
...
#   DEFINE l_pmab          RECORD LIKE pmab_t.*
   ...
   IF NOT cl_null(l_sfaa067) THEN
      ...
      LET l_pmdl.pmdl031 = l_sfaa067  #多角流程序號  #180315-00004#1
   END IF
   IF NOT cl_null(l_sfaa066) THEN  #180315-00004#1
      LET l_pmdl.pmdl051 = l_sfaa066  #多角流程代碼
   END IF  #180315-00004#1
   #LET l_pmdl.pmdl031 = l_sfaa067  #多角流程序號  #180315-00004#1
...
#        RETURNING l_pmdl.pmdl016
   ...
   IF cl_null(l_pmdl.pmdl019) THEN
      LET l_pmdl.pmdl019   = 'N'                        #納入 MPS/MRP計算   #170522-00040#1 mark   #170920-00041#2 remark
     #LET l_pmdl.pmdl019   = 'Y'                         #170522-00040#1 add   #170920-00041#2 mark
   END IF
...
PUBLIC FUNCTION s_apmt500_gen_4_ins_pmdn(p_pmdndocno,p_pmdl)
   ...
   DEFINE l_cnt1           LIKE type_t.num10      #161227-00046#1 add   
   DEFINE p_pmdl          RECORD
                          sfcbdocno     LIKE sfcb_t.sfcbdocno,
                          pmdl004       LIKE pmdl_t.pmdl004,
                          pmdl011       LIKE pmdl_t.pmdl011,
...
#   DEFINE l_sfaa          RECORD LIKE sfaa_t.*
   ...
   LET r_success = FALSE
   LET l_cnt1 = 0          #161227-00046#1 add
   #检查:应在事物中的
   IF NOT s_transaction_chk('Y','0') THEN
      RETURN r_success
   END IF
...
#   SELECT * INTO l_pmdl.* 
   ...
   #160606-00013 by whitney add end
   #161227-00046#1-s add
   IF cl_null(l_pmdl.pmdl008) OR (l_pmdl.pmdl008 <> p_pmdndocno) OR (g_prog NOT MATCHES 'asfp400*') THEN
   #161227-00046#1-e add
...
#  IF l_sfaa061 = 'Y' OR l_cnt = 0 OR p_pmdn.pmdn019 = '8' THEN
   ...
   FOR l_i = 1 TO l_cnt
       ...
       #LET l_pmdo.pmdo030   = l_pmdo.pmdo004               #分批計價單位 #170802-00017#1 mark
       #170802-00017#1 add start -----
       LET l_pmdo.pmdo030   = p_pmdn.pmdn010               #分批計價單位
       IF l_pmdo.pmdo030 <> l_pmdo.pmdo004 THEN
          CALL s_aooi250_convert_qty(l_pmdo.pmdo001,l_pmdo.pmdo004,l_pmdo.pmdo030,l_pmdo.pmdo006)
              RETURNING l_success,l_pmdo.pmdo031
       ELSE
       #170802-00017#1 add end   -----
          LET l_pmdo.pmdo031   = l_pmdo.pmdo006               #分批計價數量
       END IF #170802-00017#1 add
...
#   DEFINE l_pmab          RECORD LIKE pmab_t.*
   ...
   ##單號
   #CALL s_aooi200_gen_docno(g_site,p_doc_type,p_date,'apmt501')  #171128-00038#1 mark by 09767
   CALL s_aooi200_gen_docno(g_site,p_doc_type,p_date,'apmt503')   #171128-00038#1 modify by 09767
        RETURNING l_success,l_pmdl.pmdldocno
   IF NOT l_success THEN
      RETURN r_success,r_pmdldocno
   END IF
...
DEFINE g_prog_t        STRING #170809-00015#1 add
...
#      pmdm005 LIKE pmdm_t.pmdm005, #税前金额           #171122-00032#1 mark
       pmdm006 LIKE pmdm_t.pmdm006, #含税金额
       pmdm007 LIKE pmdm_t.pmdm007, #应付账款单号
#      pmdm008 LIKE pmdm_t.pmdm008, #主账套立账税前金额  #171122-00032#1 mark
...
#            pmdm008,pmdm009,pmdm010,pmdm011,pmdm012,
             #171122-00032#1-e mark
             #171122-00032#1-s add
             pmdm003,pmdm004,pmdm006,pmdm007,
             pmdm009,pmdm010,pmdm011,pmdm012,
             #171122-00032#1-e add
...
#     LET l_xmdb.xmdb005 = l_pmdm.pmdm005   #171122-00032#1 mark
...
#                  l_xmdb.xmdb004,l_xmdb.xmdb005,l_xmdb.xmdb006) 
      ...
      #171122-00032#1-s add      
      INSERT INTO xmdb_t(xmdbent,xmdbdocno,xmdbsite,
		                   xmdb001,xmdb002,xmdb003,xmdb004,xmdb006) 
            VALUES(g_enterprise,l_xmdb.xmdbdocno,l_xmdb.xmdbsite,
                   l_xmdb.xmdb001,l_xmdb.xmdb002,l_xmdb.xmdb003, 
                   l_xmdb.xmdb004,l_xmdb.xmdb006) 
       #171122-00032#1-e add            
       IF SQLCA.sqlcode THEN
          INITIALIZE g_errparam TO NULL
          LET g_errparam.code = SQLCA.sqlcode
...
DEFINE l_pmdl005      LIKE pmdl_t.pmdl005    #160324-00038#39 add
   ...
   IF l_pmdl005 NOT MATCHES '[256]' THEN  #160324-00038#39
      ...
      IF (NOT cl_null(p_pmdn001)) AND (NOT cl_null(p_pmdn006)) AND (NOT cl_null(p_pmdn007)) THEN
          ...
          #IF NOT cl_null(l_imaf143) THEN #171024-00026#1 mark
          IF (NOT cl_null(l_imaf143)) AND (l_imaf145 <> 0 OR l_imaf146 > p_pmdn007) THEN  #171024-00026#1 add
     ...
     #IF l_pmdl007 MATCHES '[78]' THEN   #170105-00050#7 mark
      IF l_pmdl007 MATCHES '[7]' THEN   #170105-00050#7 add
         IF r_pmdn007 > l_sum THEN
            INITIALIZE g_errparam TO NULL
   ...
   IF l_pmdl005 = '2' THEN    #160324-00038#39
      DECLARE sfcb_chk CURSOR FOR 
         SELECT DISTINCT pmdp003,pmdp004,pmdp024,pmdp009,pmdp010 FROM pmdp_t        #170524-00010#1 add pmdp009,pmdp010
               WHERE pmdpent = g_enterprise AND pmdpdocno = p_pmdldocno AND pmdpseq = p_pmdnseq
      FOREACH sfcb_chk INTO l_pmdp003,l_pmdp004,l_pmdp024,l_pmdp009,l_pmdp010       #170524-00010#1 add pmdp009,pmdp010
         #SELECT SUM(pmdp024) INTO l_pmdn007_1
         #   FROM pmdp_t,pmdl_t
         #  WHERE pmdpent = pmdlent AND pmdpdocno = pmdldocno
         #    AND pmdpent = g_enterprise AND pmdp003 = l_pmdp003 AND pmdp004 = l_pmdp004
         ...
         SELECT (CASE WHEN sfcb027 IS NULL THEN 0 ELSE sfcb027 END),(CASE WHEN sfcb029 IS NULL THEN 0 ELSE sfcb029 END),(CASE WHEN sfcb030 IS NULL THEN 0 ELSE sfcb030 END),
            ...
            FROM sfcb_t WHERE sfcbent   = g_enterprise
                          AND sfcbdocno = l_pmdp003
                          AND sfcb001   = l_pmdp004
                          AND sfcb003   = l_pmdp009  #170524-00010#1 add
                          AND sfcb004   = l_pmdp010  #170524-00010#1 add
                          AND ROWNUM = 1
        ...
        #LET l_max = l_sfcb027+l_sfcb029+l_sfcb030+l_sfcb031+l_sfcb032-l_sfcb033-l_sfcb034-l_sfcb035-l_sfcb036-l_sfcb037-l_sfcb038-l_sfcb039-l_sfcb041             #170123-00058#1 add  #170816-00043#1 mark
         LET l_max = l_sfcb027+l_sfcb029+l_sfcb030-l_sfcb033-l_sfcb034-l_sfcb035-l_sfcb036-l_sfcb037-l_sfcb038-l_sfcb039-l_sfcb041  #170816-00043#1
...
DEFINE l_qcap005     LIKE qcap_t.qcap005   #161115-00029#2 add 20161201 
   ...
   IF l_imaa044 = '1' THEN
      ...
      IF l_n = 0 OR cl_null(l_n) THEN
         ...
         #RETURN r_success
      ELSE
         #LET l_sql = l_sql , "  AND bmif017 <= '",p_pmdldocdt,"' AND (bmif018 IS NULL OR bmif018 > '",p_pmdldocdt,"') "  #170618-00419#1 mark
         LET l_sql = l_sql , "  AND bmif017 <= '",p_pmdldocdt,"' AND (bmif018 IS NULL OR bmif018 >= '",p_pmdldocdt,"') "  #170618-00419#1 add
...
DEFINE p_pmdldocno     LIKE pmdl_t.pmdldocno
DEFINE p_pmdnseq       LIKE pmdn_t.pmdnseq
DEFINE p_type          LIKE type_t.chr10   #1.增加已轉採購量 -1.減去已轉採購量   #170909-00003#1 mod 10 to 1
DEFINE l_pmdp003       LIKE pmdp_t.pmdp003
DEFINE l_pmdp004       LIKE pmdp_t.pmdp004
DEFINE l_pmdn007       LIKE pmdn_t.pmdn007
DEFINE r_success       LIKE type_t.num5
...
DEFINE l_tran             RECORD
         ...
         account          LIKE type_t.num20_6 #[35].chr 金額
                          END RECORD
DEFINE ls_js              STRING
#170511-00011#1 --s add
DEFINE l_sql              STRING
DEFINE l_pmdb046          LIKE pmdb_t.pmdb046  #費用部門
#170511-00011#1 --e add
   LET r_success = TRUE
   LET r_errno = ''
...
#     INTO l_pmdl.pmdldocdt,l_pmdl.pmdl002,l_pmdl.pmdl003,l_pmdl.pmdl015
   ...
   #170511-00011#1 --s add
   LET l_sql = " SELECT pmdb046 FROM pmdb_t ",  
               "   LEFT JOIN pmdp_t ON pmdpent = pmdbent  AND pmdp003 = pmdbdocno AND pmdp004 = pmdbseq ", 
               "  WHERE pmdbent = ",g_enterprise," AND pmdpdocno = '",p_pmdndocno,"' "
   PREPARE find_pmdb046_pre FROM l_sql
   DECLARE find_pmdb046_cs CURSOR FOR find_pmdb046_pre
   FOREACH find_pmdb046_cs INTO l_pmdb046
      IF NOT cl_null(l_pmdb046) THEN
         EXIT FOREACH
      END IF      
   END FOREACH    
   #170511-00011#1 --e add
   ...
   #LET l_tran.bgbd013 = l_pmdl.pmdl003 #170511-00011#1 mark
   LET l_tran.bgbd013 = l_pmdb046       #170511-00011#1 add
         ...
         #WHEN '3'  #訂單
          WHEN '4'  #工單
             ...
             ELSE
                ...
                SELECT COUNT(*) INTO l_n FROM sfcb_t 
                #WHERE sfcbent = g_enterprise AND sfcbsite = g_site   #171019-00015#81 mark
                 WHERE sfcbent = g_enterprise                         #171019-00015#81 add
                   AND sfcbdocno = p_pmdl008
                  #AND (sfcb027+sfcb029+sfcb030+sfcb031+sfcb032-sfcb033-sfcb034-sfcb035-sfcb036-sfcb037-sfcb038-sfcb039-sfcb041+sfcb042) > 0  #170816-00043#1 mark
                   AND (sfcb027+sfcb029+sfcb030-sfcb033-sfcb034-sfcb035-sfcb036-sfcb037-sfcb038-sfcb039-sfcb041) > 0  #170816-00043#1
...
DEFINE l_n           LIKE type_t.num5
      ...
      FOREACH azz_gen_pmdo INTO l_pmdnseq
         #170921-00009#2 add(s)  产生交期明细档前，需要产生汇总档资料
         IF NOT s_apmt500_gen_pmdq(p_pmdldocno,l_pmdnseq) THEN
            LET r_success = FALSE 
            RETURN r_success,r_xrcd103,r_xrcd104,r_xrcd105,r_xrcd113,r_xrcd114,r_xrcd115
         END IF             
         #170921-00009#2 add(e)         
...
DEFINE l_xrcd115     LIKE xrcd_t.xrcd115
   ...
   IF p_pmdm005 > 0 THEN   
#     IF p_pmdl046 = '1' AND p_pmdm014 = '2' THEN   #171122-00032#2 mark
         #含稅金額=未稅金額
...
PUBLIC FUNCTION s_apmt500_adjust_pmdn(p_pmdldocno,p_xrcd103,p_xrcd104,p_xrcd105)
   ...
   SELECT SUM(pmdn046),SUM(pmdn047),SUM(pmdn048)
     ...
     FROM pmdn_t
    WHERE pmdnent = g_enterprise
      #AND pmdnsite = g_site   #171019-00015#81 mark
      AND pmdndocno = p_pmdldocno
   ...
   IF p_xrcd103 <> l_pmdn046 OR p_xrcd104 <> l_pmdn048 OR p_xrcd105 <> l_pmdn047 THEN
     ...
     UPDATE pmdn_t SET pmdn046 = pmdn046 + (p_xrcd103-l_pmdn046),
      ...
      IF SQLCA.sqlcode THEN
         ...
         RETURN r_success         
      END IF 
      #170329-00046#3 add-S   单身调整尾差时，即更新交期尾差
      IF NOT s_apmt500_adjust_pmdo(p_pmdldocno,l_pmdnseq) THEN     
         LET r_success = FALSE
         RETURN r_success   
      END IF
      #170329-00046#3 add-E
   END IF
   RETURN r_success
END FUNCTION
...
#180424-00047#1-S
DEFINE l_pmdl002       LIKE pmdl_t.pmdl002
DEFINE l_gzxa001       LIKE gzxa_t.gzxa001
DEFINE la_param2  RECORD
       prog            STRING,
       param           DYNAMIC ARRAY OF STRING
                  END RECORD
...
#180424-00047#1-E
   ...
   #委外採購單確認時，如果來源工單的協作據點有輸入，則自動產生協作據點的訂單
   #SELECT pmdl006,pmdl051  INTO l_pmdl006,l_pmdl051                   #180424-00047#1 mark
   SELECT pmdl006,pmdl051,pmdl002  INTO l_pmdl006,l_pmdl051,l_pmdl002  #180424-00047#1 add  
   ...
   #180320-00051#1-S
   CALL s_apmt500_maillist('3',l_pmdldocno)
   #180424-00047#1-S
   #CALL apmr500_g01("pmdlent = "|| g_enterprise ||" AND pmdldocno = '"||l_pmdldocno||"'",'','')
   #準備報表執行參數
   LET la_param.prog = "apmr500"
   LET la_param.param[1] = "pmdlent = "|| g_enterprise ||" AND pmdldocno = '"||l_pmdldocno||"'"
   LET la_param.background = "Y"
   LET ls_js = util.JSON.stringify(la_param)
   #採購員作為報表執行帳號
   LET l_gzxa001 = cl_bpm_get_id(l_pmdl002)
   IF cl_null(l_gzxa001) THEN
      LET l_gzxa001 = g_account
   END IF   
   
   #呼叫awsp302中介程式，傳入apmr500的cmdrun執行參數
   LET la_param2.prog = "awsp302"
   LET la_param2.param[1] = "10"  #等BPM結案程序完成，執行報表前延遲10秒
   LET la_param2.param[2] = "apmr500"
   LET la_param2.param[3] = l_gzxa001
   LET la_param2.param[4] = ls_js
   LET ls_js2 = util.JSON.stringify(la_param2)
   DISPLAY "cmdrun:",ls_js2
   CALL cl_cmdrun(ls_js2)
   #180424-00047#1-E
   #180320-00051#1-E   
END FUNCTION

################################################################################
# Descriptions...: 判斷此單據單身稅別是否有應用公式計算和單身是否有多種不同稅別
# Memo...........: #170329-00046#2 add
# Usage..........: CALL s_apmt500_chk_pmdn016(p_pmdldocno)
#                  RETURNING r_success TRUE/FALSE 
# Return code....: 若單身稅別有應用公式計算或單身有多種不同稅別回傳FALSE,反之回傳TRUE
# Date & Author..: 2017-5-19 By zhujing
# Modify.........: 
################################################################################
PUBLIC FUNCTION s_apmt500_chk_pmdn016(p_pmdldocno)
DEFINE p_pmdldocno      LIKE pmdl_t.pmdldocno
DEFINE r_success        LIKE type_t.num5
DEFINE l_count_1      LIKE type_t.num10
DEFINE l_cnt          LIKE type_t.num10
   ...
   IF NOT cl_null(p_pmdldocno) THEN 
      ...
      SELECT COUNT(oodb002) INTO l_cnt FROM oodb_t,pmdn_t,ooef_t
        WHERE ooefent = oodbent AND ooef001 = g_site AND ooef019 = oodb001
          ...
          AND pmdnent = g_enterprise AND pmdndocno = p_pmdldocno
...
################################################################################
# Descriptions...: 取得傳入採購單據總金額資料(pmdl040(採購總未稅金額),pmdl041(採購總含稅金額),pmdl042(採購總稅額))
# Memo...........: #170329-00046#2 add
# Usage..........: CALL s_apmt500_get_pmdnamt(p_pmdldocno)
#                  RETURNING r_success,r_pmdl040,r_pmdl041,r_pmdl042
# Input parameter: 1.r_success 是否成功
# Return code....: 2.pmdl040(採購總未稅金額),3.pmdl041(採購總含稅金額),4.pmdl042(採購總稅額)# Date & Author..: 日期 By 作者
# Modify.........: 2017-5-19 By zhujing
################################################################################
PUBLIC FUNCTION s_apmt500_get_pmdnamt(p_pmdldocno)
#取得傳入採購單據總金額資料(pmdl040(採購總未稅金額),pmdl041(採購總含稅金額),pmdl042(採購總稅額))
#傳入參數1.單據編號,回傳參數1.r_success 是否成功,2.pmdl040(採購總未稅金額),3.pmdl041(採購總含稅金額),4.pmdl042(採購總稅額)
#執行s_apmt500_chk_pmdn016,若為FALSE則將單身金額欄位加總(pmdn046(未稅金額),pmdn047(含稅金額),pmdn048(稅額))回傳
#若為TRUE,則將所有採購單身pmdn015單價與pmdn011計價數量相乘之後加總金額,將取得的加總金額利用s_tax_count取得未稅金額、含稅金額、稅額回傳
DEFINE p_pmdldocno      LIKE pmdl_t.pmdldocno
DEFINE r_success        LIKE type_t.num5
DEFINE r_pmdl040        LIKE pmdl_t.pmdl040
DEFINE r_pmdl041        LIKE pmdl_t.pmdl041
DEFINE r_pmdl042        LIKE pmdl_t.pmdl042
DEFINE l_pmdl015        LIKE pmdl_t.pmdl015  #幣種
DEFINE l_pmdl016        LIKE pmdl_t.pmdl016  #匯率
DEFINE l_pmdl013        LIKE pmdl_t.pmdl013  #单价是否含税
DEFINE l_pmdn011        LIKE pmdn_t.pmdn011  #計價數量
DEFINE l_pmdn015        LIKE pmdn_t.pmdn015  #單價
DEFINE l_pmdn016        LIKE pmdn_t.pmdn016  #稅種
DEFINE l_xrcd113        LIKE xrcd_t.xrcd113
DEFINE l_xrcd114        LIKE xrcd_t.xrcd114
DEFINE l_xrcd115        LIKE xrcd_t.xrcd115
DEFINE l_success        LIKE type_t.num5
DEFINE l_sql            STRING
DEFINE l_pmdn046        LIKE pmdn_t.pmdn046  #稅前金額
DEFINE l_pmdn047        LIKE pmdn_t.pmdn047  #含稅金額
DEFINE l_pmdn048        LIKE pmdn_t.pmdn048  #稅額
DEFINE l_cnt            LIKE type_t.num10
#170602-00075#1 add-S
DEFINE  l_doc_len   LIKE type_t.num5     #單號長度
DEFINE  l_doc_len1  LIKE type_t.num5     #單號長度
#170602-00075#1 add-E
   ...
   IF NOT s_transaction_chk('Y','0') THEN
      LET r_success = FALSE
      RETURN r_success,r_pmdl040,r_pmdl041,r_pmdl042 
   END IF
   ...
   END IF
   #170602-00075#1 add-S
   LET l_doc_len = cl_get_para(g_enterprise,g_site,'E-COM-0005')
   LET l_doc_len1 = length(p_pmdldocno)
   ...
   IF l_cnt>0 THEN
      CALL s_apmt500_chk_pmdn016(p_pmdldocno) RETURNING l_success
      SELECT pmdl015,pmdl016,pmdl013 INTO l_pmdl015,l_pmdl016,l_pmdl013 FROM pmdl_t 
       WHERE pmdlent = g_enterprise
         AND pmdldocno = p_pmdldocno    
      IF l_success THEN 
         LET l_pmdn011 = 0
         LET l_pmdn015 = 0
         IF l_pmdl013 = 'Y' THEN #若单价含税，则传入含税金额加总，若不含税，则传入未税金额加总
            SELECT SUM(COALESCE(pmdn047,0)),SUM(COALESCE(pmdn011,0)),pmdn016 
              INTO l_pmdn015,l_pmdn011,l_pmdn016
              FROM pmdn_t
             WHERE pmdnent = g_enterprise
               AND pmdndocno = p_pmdldocno    
             GROUP BY pmdndocno,pmdn016     
         ELSE
            SELECT SUM(COALESCE(pmdn046,0)),SUM(COALESCE(pmdn011,0)),pmdn016 
              INTO l_pmdn015,l_pmdn011,l_pmdn016
              FROM pmdn_t
             WHERE pmdnent = g_enterprise
               AND pmdndocno = p_pmdldocno    
         ...
         END IF      
                                   #稅種     #金額     #计价数量  #幣別     #匯率
         CALL s_tax_count(g_site,l_pmdn016,l_pmdn015,l_pmdn011,l_pmdl015,l_pmdl016)
            RETURNING l_pmdn046,l_pmdn048,l_pmdn047,l_xrcd113,l_xrcd114,l_xrcd115  
         LET r_pmdl040 = l_pmdn046
         LET r_pmdl041 = l_pmdn047
         LET r_pmdl042 = l_pmdn048         
      ELSE
         #單身有多重稅別OR使用公式
         SELECT SUM(pmdn046),SUM(pmdn047),SUM(pmdn048) INTO r_pmdl040,r_pmdl041,r_pmdl042 FROM pmdn_t
          WHERE pmdnent = g_enterprise
            AND pmdndocno = p_pmdldocno      
      END IF 
      #170602-00075#1 add-S 防止传入的参数为空，报错传入为空的信息
      ...
      #呼叫幣別取位應用元件對金額作取位(依單頭幣別做取位基準)
      CALL s_curr_round(g_site,l_pmdl015,r_pmdl040,'2') RETURNING r_pmdl040
      CALL s_curr_round(g_site,l_pmdl015,r_pmdl041,'2') RETURNING r_pmdl041
      CALL s_curr_round(g_site,l_pmdl015,r_pmdl042,'2') RETURNING r_pmdl042
      #170602-00075#1 add-E
   END IF   
   #170602-00075#1 mark-S
#   IF cl_null(r_pmdl040) THEN LET r_pmdl040 = 0 END IF
#   IF cl_null(r_pmdl041) THEN LET r_pmdl041 = 0 END IF   
#   IF cl_null(r_pmdl042) THEN LET r_pmdl042 = 0 END IF      
#
...
################################################################################
# Descriptions...: 更新交期明細與單身金額的尾差處理
# Memo...........: 判斷單身項次中單身金額與交期明細中的對應項次的總金額是否一致，若存在尾差，則將尾差更新到交期明細中金額最大的那筆資料上
# ...............: #170329-00046#2 add
# Usage..........: CALL s_apmt500_adjust_pmdo(p_pmdldocno,p_pmdnseq)
#                  RETURNING r_success 
# Input parameter: p_pmdldocno    單據編號
#                : p_pmdnseq      項次
...
# Modify.........:
################################################################################
PUBLIC FUNCTION s_apmt500_adjust_pmdo(p_pmdldocno,p_pmdnseq)
#更新交期明細與單身金額的尾差處理
#傳入參數1.單據編號，2.單身項次,回傳參數1.r_success 是否成功
#判斷單身項次中單身金額與交期明細中的對應項次的總金額是否一致，若存在尾差，則將尾差更新到交期明細中金額最大的那筆資料上
#可參照apmt500_get_detail_price中將單身項次對應的金額與對應交期明細匯總存在尾差的處理方式,更新交期明細pmdo中的金額資料
DEFINE p_pmdldocno      LIKE pmdl_t.pmdldocno
DEFINE p_pmdnseq        LIKE pmdn_t.pmdnseq
DEFINE r_success        LIKE type_t.num5
DEFINE l_success       LIKE type_t.num5
...
DEFINE l_xrcd114       LIKE xrcd_t.xrcd114
DEFINE l_xrcd115       LIKE xrcd_t.xrcd115
DEFINE l_pmdn046       LIKE pmdn_t.pmdn046   #未税金额
DEFINE l_pmdn047       LIKE pmdn_t.pmdn047   #含税金额
DEFINE l_pmdn048       LIKE pmdn_t.pmdn048   #税额
DEFINE l_pmdo032       LIKE pmdo_t.pmdo032
DEFINE l_pmdo033       LIKE pmdo_t.pmdo033
DEFINE l_pmdo034       LIKE pmdo_t.pmdo034
DEFINE l_pmdo033_max   LIKE pmdo_t.pmdo033   #记录单号项次下最大的金额
DEFINE l_pmdoseq1      LIKE pmdo_t.pmdoseq1
DEFINE l_pmdoseq2      LIKE pmdo_t.pmdoseq2
   ...
   LET l_pmdo033 = 0
   LET l_pmdo034 = 0
   SELECT COALESCE(pmdn046,0),COALESCE(pmdn047,0),COALESCE(pmdn048,0) INTO l_pmdn046,l_pmdn047,l_pmdn048
      FROM pmdn_t WHERE pmdnent = g_enterprise AND pmdndocno = p_pmdldocno AND pmdnseq = p_pmdnseq
   SELECT SUM(COALESCE(pmdo032,0)),SUM(COALESCE(pmdo033,0)),SUM(COALESCE(pmdo034,0)) INTO l_pmdo032,l_pmdo033,l_pmdo034
      FROM pmdo_t WHERE pmdoent = g_enterprise AND pmdodocno = p_pmdldocno AND pmdoseq = p_pmdnseq AND pmdo003 <> '6' 
   IF l_pmdo032 <> l_pmdn046 OR l_pmdo033 <> l_pmdn047 OR l_pmdo034 <> l_pmdn048 THEN
      SELECT MAX(COALESCE(pmdo033,0)) INTO l_pmdo033_max FROM pmdo_t WHERE pmdoent = g_enterprise AND pmdodocno = p_pmdldocno AND pmdoseq = p_pmdnseq
      SELECT MIN(pmdoseq1),MIN(pmdoseq2) INTO l_pmdoseq1,l_pmdoseq2 FROM pmdo_t WHERE pmdoent = g_enterprise AND pmdodocno = p_pmdldocno AND pmdoseq = p_pmdnseq AND pmdo033 = l_pmdo033_max
         
      UPDATE pmdo_t SET pmdo032 = pmdo032 + (l_pmdn046 - l_pmdo032),
                        pmdo033 = pmdo033 + (l_pmdn047 - l_pmdo033),
                        pmdo034 = pmdo034 + (l_pmdn048 - l_pmdo034)
         WHERE pmdoent = g_enterprise AND pmdodocno = p_pmdldocno AND pmdoseq = p_pmdnseq 
           AND pmdoseq1 = l_pmdoseq1 AND pmdoseq2 = l_pmdoseq2
      IF SQLCA.sqlcode THEN
         INITIALIZE g_errparam TO NULL
         LET g_errparam.code = SQLCA.sqlcode
...
################################################################################
# Descriptions...: 將因為單據確認作業而分攤後的結果還原
# Memo...........: #170329-00046#2 add
# Usage..........: CALL s_apmt500_unconf_xrcd(p_pmdldocno)
#                  RETURNING r_success
# Input parameter: p_pmdldocno    单据编号
# Return code....: r_success      是否成功TRUE/FALSE
# Date & Author..: 2017-5-19 By zhujing
# Modify.........:
################################################################################
PUBLIC FUNCTION s_apmt500_unconf_xrcd(p_pmdldocno)
#取得該單據的交易稅明細xrcd008(調整註記)='Y'的資料,針對對應出通單項次資料重新執行s_apmt500_get_amount作業重新產生xrcd_t與將pmdn_t(pmdn046,pmdn047,pmdn048)更新為尚未分攤的資料
#所有分攤註記單身重算更新為未分攤後,執行s_apmt500_adjust_pmdo()更新交期明細pmdo中的金額資料,
#呼叫s_apmt500_get_pmdnamt取得加總金額更新採購單頭相關金額欄位pmdl040(採購總未稅金額),pmdl041(採購總含稅金額),pmdl042(採購總稅額)
DEFINE p_pmdldocno      LIKE pmdl_t.pmdldocno
DEFINE r_success        LIKE type_t.num5
DEFINE l_xrcddocno   LIKE xrcd_t.xrcddocno
DEFINE l_xrcdseq     LIKE xrcd_t.xrcdseq
DEFINE l_pmdn046     LIKE pmdn_t.pmdn046
DEFINE l_pmdn047     LIKE pmdn_t.pmdn047
DEFINE l_pmdn048     LIKE pmdn_t.pmdn048
DEFINE l_pmdl040     LIKE pmdl_t.pmdl040
DEFINE l_pmdl041     LIKE pmdl_t.pmdl041
DEFINE l_pmdl042     LIKE pmdl_t.pmdl042
DEFINE l_pmdl015     LIKE pmdl_t.pmdl015  #币别
DEFINE l_pmdn007     LIKE pmdn_t.pmdn007  #采购数量
DEFINE l_pmdn015     LIKE pmdn_t.pmdn015  #单价
DEFINE l_pmdn016     LIKE pmdn_t.pmdn016  #税别
DEFINE l_success     LIKE type_t.num5
DEFINE l_sql         STRING
   ...
   IF cl_null(p_pmdldocno) THEN
      ...
      RETURN r_success
   END IF
   LET l_sql = " SELECT DISTINCT xrcddocno,xrcdseq FROM xrcd_t ",
               "  WHERE xrcdent = ",g_enterprise,
               "    AND xrcddocno = '",p_pmdldocno,"'",
               "    AND xrcd008 = 'Y' "
   PREPARE s_apmt500_unconf_xrcd_pre FROM l_sql
   DECLARE s_apmt500_unconf_xrcd_cur CURSOR FOR s_apmt500_unconf_xrcd_pre    

   FOREACH s_apmt500_unconf_xrcd_cur INTO l_xrcddocno,l_xrcdseq
       SELECT pmdl015 INTO l_pmdl015 FROM pmdl_t WHERE pmdlent = g_enterprise AND pmdldocno = l_xrcddocno
       SELECT pmdn007,pmdn015,pmdn016 INTO l_pmdn007,l_pmdn015,l_pmdn016 FROM pmdn_t 
        WHERE pmdnent = g_enterprise
          AND pmdndocno = l_xrcddocno
          AND pmdnseq = l_xrcdseq
          
       CALL s_apmt500_get_amount(l_xrcddocno,l_xrcdseq,l_pmdl015,l_pmdn007,l_pmdn015,l_pmdn016) 
          RETURNING l_pmdn046,l_pmdn048,l_pmdn047
   
       UPDATE pmdn_t SET pmdn046 = l_pmdn046,
                         pmdn047 = l_pmdn047,
                         pmdn048 = l_pmdn048
        WHERE pmdnent = g_enterprise
          AND pmdndocno = l_xrcddocno
      ...
      IF SQLCA.SQLCODE THEN
         LET r_success = FALSE
         INITIALIZE g_errparam TO NULL 
         LET g_errparam.extend = "upd pmdn" 
         LET g_errparam.code = SQLCA.SQLCODE 
         LET g_errparam.popup = TRUE 
         CALL cl_err() 
         EXIT FOREACH
      END IF   
      #更新交期明细pmdo中的金额资料
      CALL s_apmt500_adjust_pmdo(l_xrcddocno,l_xrcdseq) RETURNING l_success
   END FOREACH 
   
   #更新單頭金額
   CALL s_apmt500_get_pmdnamt(p_pmdldocno) RETURNING l_success,l_pmdl040,l_pmdl041,l_pmdl042
   IF l_success THEN
      UPDATE pmdl_t SET pmdl040 = l_pmdl040,
                        pmdl041 = l_pmdl041,
                        pmdl042 = l_pmdl042
...
################################################################################
# Descriptions...: 更新單身資料與xrcd分攤後存在尾差的部分
# Memo...........: #170329-00046#2 add
# Usage..........: CALL s_apmt500_adjust_tax(p_pmdldocno)
#                  RETURNING r_success
# Input parameter: p_pmdldocno    单据编号
# Return code....: r_success      是否成功TRUE/FALSE# Date & Author..: 日期 By 作者
# Modify.........: 2017-5-19 By zhujing
################################################################################
PUBLIC FUNCTION s_apmt500_adjust_tax(p_pmdldocno)
#抓取單身中的金額和xrcd中金額存在尾差的項次等資料，可用條件xrcd103 <> pmdn046 OR xrcd104 <> pmdn048 OR xrcd105 <> pmdn047判斷
#若存在尾差，則根據xrcd的資料更新單身pmdn,更新後也要同步更新交期明細pmdo的尾差資料，可調用s_apmt500_adjust_pmdo()
DEFINE p_pmdldocno      LIKE pmdl_t.pmdldocno
DEFINE r_success        LIKE type_t.num5
DEFINE l_xrcddocno   LIKE xrcd_t.xrcddocno
DEFINE l_xrcdseq     LIKE xrcd_t.xrcdseq
...
DEFINE l_sql         STRING
   ...
   IF cl_null(p_pmdldocno) THEN
      ...
      RETURN r_success
   END IF
   LET l_sql = " SELECT DISTINCT xrcddocno,xrcdseq,xrcd103,xrcd104,xrcd105 FROM xrcd_t ",
               "  INNER JOIN pmdn_t ON xrcdent = pmdnent AND xrcddocno = pmdndocno AND xrcdseq = pmdnseq ",
               "  WHERE xrcdent = ",g_enterprise,
               "    AND xrcddocno = '",p_pmdldocno,"'",
               "    AND (xrcd103 <> pmdn046 OR xrcd104 <> pmdn048 OR xrcd105 <> pmdn047) "
               
   PREPARE s_apmt500_adjust_tax_pre FROM l_sql
   DECLARE s_apmt500_adjust_tax_cur CURSOR FOR s_apmt500_adjust_tax_pre
   
   FOREACH s_apmt500_adjust_tax_cur INTO l_xrcddocno,l_xrcdseq,l_xrcd103,l_xrcd104,l_xrcd105
      IF SQLCA.SQLCODE THEN
         LET r_success = FALSE
         INITIALIZE g_errparam TO NULL 
         LET g_errparam.extend = "s_apmt500_adjust_tax_cur:" 
         LET g_errparam.code = SQLCA.SQLCODE 
         LET g_errparam.popup = TRUE 
         CALL cl_err() 
      END IF     
      #更新收货/入库单身明细档
      UPDATE pmdn_t SET pmdn046 = l_xrcd103,
                        pmdn048 = l_xrcd104,
                        pmdn047 = l_xrcd105                        
       WHERE pmdnent = g_enterprise
         AND pmdndocno = l_xrcddocno
      ...
      IF SQLCA.SQLCODE THEN
         LET r_success = FALSE
         INITIALIZE g_errparam TO NULL 
         LET g_errparam.extend = "upd pmdn_t2" 
         LET g_errparam.code = SQLCA.SQLCODE 
         LET g_errparam.popup = TRUE 
         CALL cl_err() 
         LET r_success = FALSE
      END IF     
      #更新交期明细pmdo中的金额资料
      IF NOT  s_apmt500_adjust_pmdo(l_xrcddocno,l_xrcdseq) THEN
         LET r_success = FALSE
      END IF
   END FOREACH 
...
################################################################################
# Descriptions...: 檢查付款條件、採購稅別、交易條件、
#                : 發票類型是否與多角流程第0站設定相同
#                : 以及供應商是下一站據點的供應商
# Memo...........:
# Usage..........: CALL s_apmt500_icae_chk(p_pmdldocno,p_pmdl051)
#                  RETURNING r_success
# Input parameter: p_pmdldocno    採購單號
#                : p_pmdl051      多角流程編號
# Return code....: r_success      TRUE/FALSE
# Date & Author..: 2017/08/24 By dorislai (#170618-00068#2)
# Modify.........:
################################################################################
PUBLIC FUNCTION s_apmt500_icae_chk(p_pmdldocno,p_pmdl051)
   DEFINE p_pmdldocno   LIKE pmdl_t.pmdldocno
   DEFINE p_pmdl051     LIKE pmdl_t.pmdl051
   DEFINE r_success     LIKE type_t.num5
   DEFINE l_cnt         LIKE type_t.num5
   ...
   #第0站才需要檢查資料是否與aici100相同
   LET l_cnt = 0
   SELECT COUNT(1) INTO l_cnt
     FROM icab_t
    WHERE icabent = g_enterprise
      AND icab001 = p_pmdl051
      AND icab002 = 0 AND icab003 = g_site
   IF l_cnt = 0 THEN
      RETURN r_success
   END IF
   
   #取得採購單的資料
   #180131-00013#2 mark --s
   #SELECT pmdl004,pmdl009,pmdl010,pmdl011,pmdl033
   #  INTO l_pmdl.pmdl004,l_pmdl.pmdl009,l_pmdl.pmdl010,l_pmdl.pmdl011,l_pmdl.pmdl033
   #180131-00013#2 mark --e
   #180131-00013#2 add --s
   SELECT pmdl004,pmdl009,pmdl010,pmdl011,pmdl033,pmdl021,pmdl022,pmdl006
     INTO l_pmdl.pmdl004,l_pmdl.pmdl009,l_pmdl.pmdl010,l_pmdl.pmdl011,l_pmdl.pmdl033,
          l_pmdl.pmdl021,l_pmdl.pmdl022,l_pmdl.pmdl006
   #180131-00013#2 add --e
     FROM pmdl_t
    WHERE pmdlent = g_enterprise AND pmdldocno = p_pmdldocno
   #180131-00013#2 add --s
   IF l_pmdl.pmdl006 = '6' THEN
      RETURN r_success
   END IF
   #180131-00013#2 add --e
   
   #取得多角流程相關的設定資料
   SELECT icae010,icae012,icae015,icae021
     INTO l_pair.icae010,l_pair.icae012,l_pair.icae015,l_pair.icae021
     FROM icae_t
    WHERE icaeent = g_enterprise
      AND icae001 = p_pmdl051
      AND icae002 = 0
      
   #取得營運據點"廠商編號"
   SELECT ooef024 INTO l_pair.ooef024
     FROM icab_t,ooef_t
    WHERE icabent = ooefent      AND icab003 = ooef001
      AND icabent = g_enterprise AND icab001 = p_pmdl051
      AND icab002 = 1
   
   #檢查供應商
   IF l_pmdl.pmdl004 <> l_pair.ooef024 OR cl_null(l_pair.ooef024) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01203"   #採購單：%1的供應商：%2，與多角流程編號：%3的供應商：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl004
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.ooef024
      LET g_errparam.replace[5] = cl_getmsg("bph-00002",g_lang)   #供應商 #180131-00013#2 add
      CALL cl_err()
   ...
   #180131-00013#2 add --s
   #檢查付款供應商
   IF l_pmdl.pmdl021 <> l_pair.ooef024 OR cl_null(l_pair.ooef024) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01203"   #採購單：%1的%5供應商：%2，與多角流程編號：%3的供應商：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl021
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.ooef024
      LET g_errparam.replace[5] = cl_getmsg("apm-08368",g_lang)   #付款供應商
      CALL cl_err()

      LET r_success = FALSE
   END IF
   #檢查送貨供應商
   IF l_pmdl.pmdl022 <> l_pair.ooef024 OR cl_null(l_pair.ooef024) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01203"   #採購單：%1的%5供應商：%2，與多角流程編號：%3的供應商：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl022
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.ooef024
      LET g_errparam.replace[5] = cl_getmsg("aic-00218",g_lang)   #送貨供應商
      CALL cl_err()
   ...
   #180131-00013#2 add --e
   #檢查付款條件
   IF l_pmdl.pmdl009 <> l_pair.icae010 OR cl_null(l_pair.icae010) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01204"   #採購單：%1的付款條件：%2，與多角流程編號：%3的付款條件：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl009
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.icae010    
      CALL cl_err()
      
      LET r_success = FALSE
   END IF
   #檢查交易條件
   IF l_pmdl.pmdl010 <> l_pair.icae015 OR cl_null(l_pair.icae015) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01205"   #採購單：%1的交易條件：%2，與多角流程編號：%3的交易條件：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl010
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.icae015   
      CALL cl_err()
      
      LET r_success = FALSE
   END IF
   #檢查採購稅別
   IF l_pmdl.pmdl011 <> l_pair.icae012 OR cl_null(l_pair.icae012) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01206"   #採購單：%1的採購稅別：%2，與多角流程編號：%3的採購稅別：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl011
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.icae012   
      CALL cl_err()
      
      LET r_success = FALSE
   END IF
   #檢查發票類型
   IF l_pmdl.pmdl033 <> l_pair.icae021 OR cl_null(l_pair.icae021) THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.extend = ""
      LET g_errparam.code   = "apm-01207"   #採購單：%1的發票類型：%2，與多角流程編號：%3的發票類型：%4，不相等！
      LET g_errparam.popup  = TRUE
      LET g_errparam.replace[1] = p_pmdldocno
      LET g_errparam.replace[2] = l_pmdl.pmdl033
      LET g_errparam.replace[3] = p_pmdl051
      LET g_errparam.replace[4] = l_pair.icae021      
      CALL cl_err()
...
################################################################################
# Descriptions...: 收件人資訊、郵件信件主旨內容等
# Memo...........: COPY FROM 原apmt500.4gl內的apmt500_mallist()

# Date & Author..: #171116-00011#1 

################################################################################
PUBLIC FUNCTION s_apmt500_maillist(p_type,p_pmdldocno)
...
DEFINE p_type       LIKE type_t.chr1      
   ...
   #供應商聯絡對象識別碼
   SELECT pmaa027 INTO l_pmaa027 FROM pmaa_t,pmdl_t WHERE pmaaent = g_enterprise AND pmaa001 = pmdl004 AND pmdldocno = p_pmdldocno AND pmdlent = g_enterprise

   #採購人員聯絡對象識別碼
   SELECT ooag002 INTO l_ooag002 FROM ooag_t,pmdl_t WHERE ooagent = g_enterprise AND ooag001 = pmdl002 AND pmdldocno = p_pmdldocno AND pmdlent = g_enterprise

   #供應商聯絡對象識別碼
   DECLARE apmt500_mailpmaj CURSOR FOR
   SELECT pmaj002 FROM pmaj_t,pmdl_t WHERE pmajent = g_enterprise AND pmaj001 = pmdl004 AND pmdldocno = p_pmdldocno AND pmdlent = g_enterprise
   LET l_pmaj002_mail = ''
   FOREACH apmt500_mailpmaj INTO l_pmaj002
      IF cl_null(l_pmaj002_mail) THEN
         LET l_pmaj002_mail = "'",l_pmaj002
      ELSE
         LET l_pmaj002_mail = l_pmaj002_mail,"','",l_pmaj002
      END IF
   END FOREACH
   IF NOT cl_null(l_pmaj002_mail) THEN
      LET l_pmaj002_mail = l_pmaj002_mail,"'"
   END IF
   ...
   IF NOT cl_null(l_pmaj002_mail) THEN
      LET l_sql = "SELECT oofc012 FROM oofc_t WHERE oofcent = '",g_enterprise,"'",
                  "   AND ((oofc002 = '",l_pmaa027,"' AND oofc015 = 'Y' AND oofc008 = '4') ",
                  "    OR (oofc002 IN (",l_pmaj002_mail,") AND oofc015 = 'Y' AND oofc008 = '4') ",
                  "    OR (oofc002 = '",l_ooag002,"' AND oofc008 = '4')) ",
                  "   AND oofcstus = 'Y' "
   ELSE
      LET l_sql = "SELECT oofc012 FROM oofc_t WHERE oofcent = '",g_enterprise,"'",
                  "   AND ((oofc002 = '",l_pmaa027,"' AND oofc015 = 'Y' AND oofc008 = '4') ",
                  ...
                  "   AND oofcstus = 'Y' "
   END IF
   PREPARE mail_send_pre FROM l_sql
   DECLARE mail_send CURSOR FOR mail_send_pre
   FOREACH mail_send INTO l_oofc012
      ...
      LET g_schedule_d[i].gzpe008 = l_oofc012    #收件者名稱   #170512-00085#1 add
...
################################################################################
# Descriptions...:取得傳入採購單據總金額資料(pmdl040(採購總未稅金額),pmdl041(採購總含稅金額),pmdl042(採購總稅額))，並利用s_tax_recount交易稅總額重計，根據進行尾差處理
# Memo...........:
# Usage..........: CALL s_apmt500_adjust_amount(p_pmdldocno)
#                  RETURNING 回传参数
# Input parameter: 传入参数变量1   传入参数变量说明1
#                : 传入参数变量2   传入参数变量说明2
# Return code....: 回传参数变量1   回传参数变量说明1
#                : 回传参数变量2   回传参数变量说明2
# Date & Author..: 171214-00052#8  by 09767
# Modify.........:
################################################################################
PUBLIC FUNCTION s_apmt500_adjust_amount(p_pmdldocno)
DEFINE p_pmdldocno     LIKE pmdl_t.pmdldocno
DEFINE r_pmdl040    LIKE pmdl_t.pmdl040
DEFINE r_pmdl041    LIKE pmdl_t.pmdl041
DEFINE r_pmdl042    LIKE pmdl_t.pmdl042
...
DEFINE r_success       LIKE type_t.num5
   ...
   IF l_success THEN
      #交易稅總額重計
      CALL s_tax_recount(p_pmdldocno) RETURNING r_pmdl040,r_pmdl042,r_pmdl041,l_xrcd113,l_xrcd114,l_xrcd115
      UPDATE pmdl_t SET pmdl040 = r_pmdl040,
                        pmdl041 = r_pmdl041,
                        pmdl042 = r_pmdl042   
       WHERE pmdlent = g_enterprise
         AND pmdldocno = p_pmdldocno       
   ...
   ELSE
      #未税/含税/税额
      SELECT SUM(pmdn046),SUM(pmdn047),SUM(pmdn048) INTO r_pmdl040,r_pmdl041,r_pmdl042
        FROM pmdn_t
       WHERE pmdnent   = g_enterprise
         AND pmdndocno = p_pmdldocno
      IF cl_null(r_pmdl040) THEN LET r_pmdl040 = 0 END IF
      IF cl_null(r_pmdl041) THEN LET r_pmdl041 = 0 END IF
      IF cl_null(r_pmdl042) THEN LET r_pmdl042 = 0 END IF
      UPDATE pmdl_t SET pmdl040 = r_pmdl040, pmdl041 = r_pmdl041, pmdl042 = r_pmdl042
       WHERE pmdlent   = g_enterprise
         AND pmdldocno = p_pmdldocno
      IF SQLCA.sqlcode THEN
         INITIALIZE g_errparam TO NULL
...
################################################################################
# Descriptions...: 依據採購單，帶出採購單對應欄位的值
# Memo...........: 
# Usage..........: CALL s_apmt500_pmeedocno_pmee(pmeedocno)
#                : RETURNING r_pmee900,r_success
# Input parameter: p_pmeedocno    #採購變更單號
# Return code....: r_pmee900      #變更序
#                  r_success      #ture/false
# Date & Author..: 2018/01/25 By 10042
# Modify.........: #171206-00046#2 add
################################################################################
PUBLIC FUNCTION s_apmt500_pmeedocno_pmee(p_pmeedocno)
   DEFINE p_pmeedocno  LIKE pmee_t.pmeedocno #採購變更單號
   DEFINE l_pmee RECORD  #採購變更單頭檔
       ...
       pmee019 LIKE pmee_t.pmee019, #納入AMRP計算
       ...
       pmee051 LIKE pmee_t.pmee051, #多角流程編號
       ...
       pmee200 LIKE pmee_t.pmee200, #採購中心
       pmee201 LIKE pmee_t.pmee201, #聯絡電話
       pmee202 LIKE pmee_t.pmee202, #傳真號碼
       pmee900 LIKE pmee_t.pmee900, #變更序
       pmee901 LIKE pmee_t.pmee901, #變更類型
       pmee902 LIKE pmee_t.pmee902, #變更日期
       pmee903 LIKE pmee_t.pmee903, #變更理由
       pmee904 LIKE pmee_t.pmee904, #變更備註
       pmeeunit LIKE pmee_t.pmeeunit, #應用組織
       ...
       pmeemodid LIKE pmee_t.pmeemodid, #資料修改者
       pmeemoddt LIKE pmee_t.pmeemoddt, #最近修改日
       pmeecnfid LIKE pmee_t.pmeecnfid, #資料確認者
       pmeecnfdt LIKE pmee_t.pmeecnfdt, #資料確認日
       pmeestus LIKE pmee_t.pmeestus, #狀態碼
       pmeeacti LIKE pmee_t.pmeeacti  #採購單結案否
   END RECORD
   DEFINE r_success         LIKE type_t.num5
   DEFINE r_pmee900         LIKE pmee_t.pmee900
   ...
   END IF
   LET r_pmee900 = l_pmee.pmee900
   
   #抓取採購單單頭資料，新增到採購變更單單頭
   SELECT pmdldocdt,
          pmdl001,pmdl002,pmdl003,pmdl004,pmdl005,
          pmdl006,pmdl007,pmdl008,pmdl009,pmdl010,
          ...
          pmdl046,pmdl047,pmdl048,pmdl049,
          pmdl051,pmdl052,pmdl053,pmdl054,pmdl055,
          pmdl050   
     INTO l_pmee.pmeedocdt,
          ...
          l_pmee.pmee011,l_pmee.pmee012,l_pmee.pmee013,               l_pmee.pmee015,
          l_pmee.pmee016,l_pmee.pmee017,l_pmee.pmee018,l_pmee.pmee019,l_pmee.pmee020,
          l_pmee.pmee021,l_pmee.pmee022,l_pmee.pmee023,l_pmee.pmee024,l_pmee.pmee025,
          l_pmee.pmee026,l_pmee.pmee027,l_pmee.pmee028,l_pmee.pmee029,l_pmee.pmee030,
          l_pmee.pmee031,l_pmee.pmee032,l_pmee.pmee033,
                                                                      l_pmee.pmee040,
          l_pmee.pmee041,l_pmee.pmee042,l_pmee.pmee043,l_pmee.pmee044,
          l_pmee.pmee046,l_pmee.pmee047,l_pmee.pmee048,l_pmee.pmee049,
          l_pmee.pmee051,l_pmee.pmee052,l_pmee.pmee053,l_pmee.pmee054,l_pmee.pmee055,
          l_pmee.pmee050
     FROM pmdl_t
    WHERE pmdlent = g_enterprise
   ...
   IF SQLCA.sqlcode THEN
      ...
      LET r_success = FALSE
      RETURN r_pmee900,r_success
   END IF
   #版本 = 目前[T:採購單單頭檔].[C:版本]加1 
   LET l_pmee.pmee001 = l_pmee.pmee001 + 1
   #公用欄位新增給值 
   ...
   LET l_pmee.pmeemodid = g_user
   LET l_pmee.pmeemoddt = cl_get_current()
   ...
   INSERT INTO pmee_t(pmeeent,pmeesite,pmeedocno,pmeedocdt,
                      pmee001,pmee002,pmee003,pmee004,pmee005,
                      pmee006,pmee007,pmee008,pmee009,pmee010,
                      pmee011,pmee012,pmee013,        pmee015,
                      pmee016,pmee017,pmee018,pmee019,pmee020,
                      pmee021,pmee022,pmee023,pmee024,pmee025,
                      pmee026,pmee027,pmee028,pmee029,pmee030,
                      pmee031,pmee032,pmee033,
                                                      pmee040,
                      pmee041,pmee042,pmee043,pmee044,
                      pmee046,pmee047,pmee048,pmee049,pmee050,
                      pmee051,pmee052,pmee053,pmee054,pmee055,
                                                      pmee900,
                      pmee901,pmee902,
                      pmeeownid,pmeeowndp,pmeecrtid,pmeecrtdp,pmeecrtdt,
                      pmeemodid,pmeemoddt,pmeestus,
                      pmeeacti)
      VALUES(g_enterprise,g_site,p_pmeedocno,l_pmee.pmeedocdt,
             l_pmee.pmee001,l_pmee.pmee002,l_pmee.pmee003,l_pmee.pmee004,l_pmee.pmee005,
             l_pmee.pmee006,l_pmee.pmee007,l_pmee.pmee008,l_pmee.pmee009,l_pmee.pmee010,
             l_pmee.pmee011,l_pmee.pmee012,l_pmee.pmee013,               l_pmee.pmee015,
             l_pmee.pmee016,l_pmee.pmee017,l_pmee.pmee018,l_pmee.pmee019,l_pmee.pmee020,
             ...
             l_pmee.pmee031,l_pmee.pmee032,l_pmee.pmee033,
                                                                         l_pmee.pmee040,
             l_pmee.pmee041,l_pmee.pmee042,l_pmee.pmee043,l_pmee.pmee044,
             l_pmee.pmee046,l_pmee.pmee047,l_pmee.pmee048,l_pmee.pmee049,l_pmee.pmee050,
             l_pmee.pmee051,l_pmee.pmee052,l_pmee.pmee053,l_pmee.pmee054,l_pmee.pmee055,
                                                                         l_pmee.pmee900,
             l_pmee.pmee901,l_pmee.pmee902,
             l_pmee.pmeeownid,l_pmee.pmeeowndp,l_pmee.pmeecrtid,l_pmee.pmeecrtdp,l_pmee.pmeecrtdt,
             l_pmee.pmeemodid,l_pmee.pmeemoddt,l_pmee.pmeestus,
             l_pmee.pmeeacti)
   IF SQLCA.sqlcode THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.code = SQLCA.sqlcode
      LET g_errparam.extend = 'ins_pmee'
      LET g_errparam.popup = TRUE
      CALL cl_err()
...
################################################################################
# Descriptions...: 依據來源單據帶出採購多交期匯總檔
# Memo...........:
# Usage..........: CALL s_apmt500_pmeedocno_pmej(p_pmeedocno,p_pmee900)
#                : RETURNING r_success
# Input parameter: p_pmeedocno    #採購變更單號
#                  p_pmee900      #變更序
...
# Modify.........: #171206-00046#2 add
################################################################################
PUBLIC FUNCTION s_apmt500_pmeedocno_pmej(p_pmeedocno,p_pmee900)
   DEFINE p_pmeedocno LIKE pmee_t.pmeedocno #採購變更單號
   DEFINE r_success   LIKE type_t.num5
   ...
   LET l_sql = " INSERT INTO pmej_t",
               "            (pmejent,pmejsite,pmejdocno,pmej900,pmej901,",
               "             pmejseq,pmej001,pmej002,pmej003,pmej004,",
               "             pmej005,pmej006,pmej007,pmej008)",
               " SELECT pmdqent,pmdqsite,pmdqdocno,'",p_pmee900,"','1',",
               "        pmdqseq,pmdqseq2,pmdq002,pmdq003,pmdq004,",
               "        pmdq005,pmdq006,pmdq007,pmdq008 ", 
               "   FROM pmdq_t ",
               "  WHERE pmdqent = ",g_enterprise,
               "    AND pmdqdocno = '",p_pmeedocno,"'"
   PREPARE s_apmt500_pmej FROM l_sql
   EXECUTE s_apmt500_pmej
   FREE s_apmt500_pmej

   IF SQLCA.sqlcode THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.code = SQLCA.sqlcode
      LET g_errparam.extend = 'ins_pmej'
      LET g_errparam.popup = TRUE
      CALL cl_err()
...
################################################################################
# Descriptions...: 依據來源單號帶出採購單明細檔
# Memo...........:
# Usage..........: CALL s_apmt500_pmeedocno_pmeg(p_pmeedocno,p_pmee900)
#                : RETURNING r_success
# Input parameter: p_pmeedocno    #採購變更單號
#                  p_pmee900      #變更序
# Return code....: r_success      #true/false
...
# Modify.........: #171206-00046#2 add
################################################################################
PUBLIC FUNCTION s_apmt500_pmeedocno_pmeg(p_pmeedocno,p_pmee900)
   DEFINE p_pmeedocno LIKE pmee_t.pmeedocno #採購變更單號
   DEFINE r_success   LIKE type_t.num5
   DEFINE p_pmee900   LIKE pmee_t.pmee900
   DEFINE l_sql       STRING
   ...
   LET l_sql = " INSERT INTO pmeg_t",
               ...
               "             pmeg021,pmeg022,pmegunit,pmegorga,pmeg049,",
               "             pmeg027,pmeg028,pmeg029,pmeg030,pmeg053,",
               "             pmeg025,pmeg026,pmeg031,pmeg032,pmeg033,",
               "             pmeg003,pmeg036,pmeg037,pmeg038,pmeg058,",
               "             pmeg039,pmeg035,pmeg040,pmeg041,pmeg042,",
               "             pmeg043,pmeg050,pmeg044,pmeg051,pmeg052,",
               "             pmeg059,pmeg060)",
               " SELECT pmdnent,pmdndocno,'",p_pmee900,"',pmdnsite,'1',",
               "        pmdnseq,pmdn001,pmdn002,pmdn004,pmdn005,",
               "        pmdn006,pmdn007,pmdn008,pmdn009,pmdn024,",
               "        pmdn012,pmdn013,pmdn014,pmdn045,pmdn010,",
               "        pmdn011,pmdn015,pmdn016,pmdn017,pmdn046,",
               "        pmdn047,pmdn048,pmdn023,pmdn019,pmdn020,",
               "        pmdn021,pmdn022,pmdnunit,pmdnorga,pmdn049,",
               "        pmdn027,pmdn028,pmdn029,pmdn030,pmdn053,",
               "        pmdn025,pmdn026,pmdn031,pmdn032,pmdn033,",
               "        pmdn003,pmdn036,pmdn037,pmdn038,pmdn058,",
               "        pmdn039,pmdn035,pmdn040,pmdn041,pmdn042,",
               "        pmdn043,pmdn050,pmdn044,pmdn051,pmdn052,",
               "        pmdn059,pmdn060",
               "   FROM pmdn_t ",
               "  WHERE pmdnent = ",g_enterprise,
               "    AND pmdndocno = '",p_pmeedocno,"' "
   PREPARE s_apmt500_pmeg FROM l_sql
   EXECUTE s_apmt500_pmeg
   FREE s_apmt500_pmeg

   IF SQLCA.sqlcode THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.code = SQLCA.sqlcode
      LET g_errparam.extend = 'ins_pmeg'
      LET g_errparam.popup = TRUE
      CALL cl_err()
...
################################################################################
# Descriptions...: 依據來源單號帶出採購交期明細檔
# Memo...........:
# Usage..........: CALL s_apmt500_pmeedocno_pmeh(p_pmeedocno,p_pmee900)
#                : RETURNING r_success                
# Input parameter: p_pmeedocno    #採購變更單號
#                  p_pmee900      #變更序
# Return code....: r_success      #true/false
...
# Modify.........: #171206-00046#2 add
################################################################################
PUBLIC FUNCTION s_apmt500_pmeedocno_pmeh(p_pmeedocno,p_pmee900)
   DEFINE p_pmeedocno LIKE pmee_t.pmeedocno #採購變更單號
   DEFINE r_success   LIKE type_t.num5
   DEFINE p_pmee900   LIKE pmee_t.pmee900
   DEFINE l_sql       STRING
   ...
   LET l_sql = " INSERT INTO pmeh_t",
               ...
               " SELECT pmdoent,pmdodocno,pmdosite,'",p_pmee900,"',",
               "        pmdoseq,pmdoseq1,pmdo003,pmdo001,",
               "        pmdo002,pmdo004,pmdo005,pmdoseq2,",
               "        pmdo006,pmdo028,pmdo029,pmdo011,",
               "        pmdo012,pmdo013,pmdo010,pmdo014,",
               "        pmdo009,pmdo015,pmdo016,pmdo017,",
               "        pmdo019,pmdo020,pmdo021,pmdo030,",
               "        pmdo031,pmdo022,pmdo023,pmdo024,",
               "        pmdo032,pmdo033,pmdo034,pmdo025,",
               "        pmdo026,pmdo027,'1'",
               "   FROM pmdo_t ",
               "  WHERE pmdoent = ",g_enterprise,
               "    AND pmdodocno = '",p_pmeedocno,"' "
               
   PREPARE s_apmt500_pmeh FROM l_sql
   EXECUTE s_apmt500_pmeh
   FREE s_apmt500_pmeh

   IF SQLCA.sqlcode THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.code = SQLCA.sqlcode
      LET g_errparam.extend = 'ins_pmeh'
      LET g_errparam.popup = TRUE
      CALL cl_err()
...
################################################################################
# Descriptions...: 依據來源單據帶出採購關聯單據明細檔
# Memo...........:
# Usage..........: CALL s_apmt500_pmeedocno_pmei(p_pmeedocno,p_pmee900)
#                : RETURNING r_success                  
# Input parameter: p_pmeedocno    #採購變更單號
#                  p_pmee900      #變更序
# Return code....: r_success      #ture/false
...
# Modify.........: #171206-00046#2 add
################################################################################
PUBLIC FUNCTION s_apmt500_pmeedocno_pmei(p_pmeedocno,p_pmee900)
   DEFINE p_pmeedocno LIKE pmee_t.pmeedocno #採購變更單號
   DEFINE r_success   LIKE type_t.num5
   DEFINE p_pmee900   LIKE pmee_t.pmee900
   DEFINE l_sql       STRING
   ...
   LET l_sql = " INSERT INTO pmei_t",
               "            (pmeient,pmeidocno,pmeisite,pmei900,",
               "             pmeiseq,pmeiseq1,pmei001,pmei002,pmei003,",
               "             pmei004,pmei005,pmei006,pmei007,pmei008,",
               "             pmei009,pmei010,pmei021,pmei022,pmei023,",
               "             pmei024,pmei025,pmei026,pmei901)",
               " SELECT pmdpent,pmdpdocno,pmdpsite,'",p_pmee900,"',",
               "        pmdpseq, pmdpseq1,pmdp001,pmdp002,pmdp003, ",
               "        pmdp004,pmdp005,pmdp006,pmdp007,pmdp008,",
               "        pmdp009,pmdp010,pmdp021,pmdp022,pmdp023,",
               "        pmdp024,pmdp025,pmdp026,'1'",
               "   FROM pmdp_t ",
               "  WHERE pmdpent = ",g_enterprise,
               "    AND pmdpdocno = '",p_pmeedocno,"' "
   PREPARE s_apmt500_pmei FROM l_sql
   EXECUTE s_apmt500_pmei
   FREE s_apmt500_pmei

   IF SQLCA.sqlcode THEN
      INITIALIZE g_errparam TO NULL
      LET g_errparam.code = SQLCA.sqlcode
      LET g_errparam.extend = 'ins_pmei'
      LET g_errparam.popup = TRUE
      CALL cl_err()
...
# Descriptions...: 多角自動拋轉
# Memo...........:
# Usage..........: CALL s_apmt500_aic_auto_cast(p_pmdldocno)
#                  RETURNING r_success
# Input parameter: p_pmdldocno    單號
# Return code....: r_success      TRUE/FALSE
# Date & Author..: 2018/02/12 By 08993 (170617-00078#3 add)
# Modify.........: 
################################################################################
PUBLIC FUNCTION s_apmt500_aic_auto_cast(p_pmdldocno)
   DEFINE p_pmdldocno    LIKE pmdl_t.pmdldocno
   DEFINE l_pmdl006      LIKE pmdl_t.pmdl006
   DEFINE l_pmdl051      LIKE pmdl_t.pmdl051
   DEFINE l_pmdl030      LIKE pmdl_t.pmdl030
   ...
   LET l_pmdl006 = ''
   LET l_pmdl051 = ''
   SELECT pmdl006,pmdl051
     INTO l_pmdl006,l_pmdl051
     FROM pmdl_t
    WHERE pmdlent = g_enterprise
      AND pmdldocno = p_pmdldocno
   ...
   IF cl_get_para(g_enterprise,'','E-BAS-0022') = 'Y' AND
      ...
      INITIALIZE la_param.* TO NULL
      LET la_param.prog     = 'aicp200'
      LET la_param.param[1] = p_pmdldocno
      LET la_param.param[2] = g_sessionkey
      LET ls_js = util.JSON.stringify(la_param)
      CALL cl_cmdrun_wait(ls_js)
      ...
      IF l_pmdl030 <> 'Y' THEN
         ...
         CALL s_apmt500_show_aicerrmsg(g_sessionkey,p_pmdldocno)          
         INITIALIZE g_errparam TO NULL
         LET g_errparam.code   = 'aic-00177'
         LET g_errparam.popup  = TRUE
         CALL cl_err()        
...
# Memo...........:
# Usage..........: CALL s_apmt500_aic_auto_reduce(p_pmdldocno)
#                  RETURNING r_success
# Input parameter: p_pmdldocno    單號
# Return code....: r_success      TRUE/FALSE
# Date & Author..: 2018/02/12 By 08993 (170617-00078#3 add)
# Modify.........: 
################################################################################
PUBLIC FUNCTION s_apmt500_aic_auto_reduce(p_pmdldocno)
   DEFINE p_pmdldocno    LIKE pmdl_t.pmdldocno
   DEFINE l_pmdl006      LIKE pmdl_t.pmdl006
   DEFINE l_pmdl051      LIKE pmdl_t.pmdl051
   DEFINE l_pmdl030      LIKE pmdl_t.pmdl030
...
# Descriptions...: 描述说明
# Memo...........:
# Usage..........: CALL s_apmt500_show_aicerrmsg(p_sessionkey,p_pmdldocno)
...
# Modify.........:
################################################################################
PUBLIC FUNCTION s_apmt500_show_aicerrmsg(p_sessionkey,p_pmdldocno)
DEFINE p_sessionkey    LIKE icer_t.icer001 
DEFINE p_pmdldocno     LIKE icer_t.icer003
DEFINE l_cnt           LIKE type_t.num5
DEFINE l_icer RECORD
   ...
   SELECT COUNT(1) INTO l_cnt
    ...
    WHERE icerent = g_enterprise 
      ...
      AND icer002 = g_user
      AND icer003 = p_pmdldocno

   IF cl_null(l_cnt) THEN LET l_cnt = 0 END IF
   
   IF l_cnt > 0 THEN
      LET g_coll_title[1] = cl_getmsg('apm-01033',g_dlang) #採購單號      
      LET g_coll_title[2] = cl_getmsg('aap-00154',g_dlang) #單據日期  
      LET g_coll_title[3] = cl_getmsg('apm-00050',g_dlang) #供應商編號
      LET g_coll_title[4] = cl_getmsg('aic-00219',g_dlang) #供應商名稱
      LET g_coll_title[5] = cl_getmsg('apm-01250',g_dlang) #採購人員
      LET g_coll_title[6] = cl_getmsg('axm-00929',g_dlang) #全名
      LET g_coll_title[7] = cl_getmsg('apm-01251',g_dlang) #採購部門
      LET g_coll_title[8] = cl_getmsg('axm-00930',g_dlang) #部門名稱 
      LET g_coll_title[9] = cl_getmsg('axm-00931',g_dlang) #多角流程編號
      LET g_coll_title[10] = cl_getmsg('apm-01252',g_dlang) #最終供應商
      LET g_coll_title[11] = cl_getmsg('bph-00006',g_dlang) #名稱
      LET g_coll_title[12] = cl_getmsg('amm-00374',g_dlang) #營運據點 
      LET g_coll_title[13] = cl_getmsg('axm-00932',g_dlang) #營運據點名稱      
   
      DECLARE s_apmt500_get_icer_cs CURSOR FOR
      ...
      FOREACH s_apmt500_get_icer_cs 
         ...
         LET g_errparam.coll_vals[10] = l_icer.icer023
         LET g_errparam.coll_vals[11] = l_icer.icer024
         LET g_errparam.coll_vals[12] = l_icer.icer025
         LET g_errparam.coll_vals[13] = l_icer.icer026
...
################################################################################
# Descriptions...: 写入pspo_t表中
# Memo...........:
# Usage..........: CALL s_ins_pspo(p_site,p_fed_order_id,p_source_id)
#                  RETURNING r_success
# Input parameter: p_site       营运据点
#                : p_order_id   当前fed_order_id
#                : p_item       料号
#                : p_qty        数量
#                : p_source_id  来源fed_order_id
# Return code....: r_success    TRUE/FALSE
# Date & Author..: 2018/4/2 By 02294
# Modify.........: #180402-00035#4 add
################################################################################
PUBLIC FUNCTION s_apmt500_ins_pspo(p_site,p_order_id,p_item,p_qty,p_source_id)
DEFINE p_site      LIKE ooef_t.ooef001
DEFINE p_order_id  LIKE pspo_t.pspo003
DEFINE p_item      LIKE pspo_t.pspo011
DEFINE p_qty       LIKE pspo_t.pspo007
DEFINE p_source_id LIKE pspo_t.pspo003
DEFINE l_pspo015   LIKE pspo_t.pspo015
DEFINE l_pspo014   LIKE pspo_t.pspo014
DEFINE r_success   LIKE type_t.num5
DEFINE l_n         LIKE type_t.num10
   ...
   LET l_n = 0
   SELECT COUNT(1) INTO l_n FROM pspo_t 
     WHERE pspoent = g_enterprise AND psposite = p_site
       AND pspo001 = ' ' AND pspo002 = ' ' AND pspo003 = p_source_id
   IF l_n > 0 THEN    
      DECLARE pspo014_cs CURSOR FOR
         SELECT DISTINCT pspo014  FROM pspo_t 
         WHERE pspoent = g_enterprise AND psposite = p_site
           AND pspo001 = ' ' AND pspo002 = ' ' AND pspo003 = p_source_id
      FOREACH pspo014_cs INTO l_pspo014   
         #同樣的需求單號出現一筆
         LET l_n = 0
         SELECT COUNT(1) INTO l_n FROM pspo_t 
            WHERE pspoent = g_enterprise AND psposite = p_site
              AND pspo001 = ' ' AND pspo002 = ' ' AND pspo014 = l_pspo014
              AND pspo003 = p_order_id
         IF l_n = 0 OR cl_null(l_n) THEN
            SELECT MAX(pspo015)+1 INTO l_pspo015 FROM pspo_t 
               WHERE pspoent = g_enterprise AND psposite = p_site
                 AND pspo001 = ' ' AND pspo002 = ' ' 
            IF cl_null(l_pspo015) OR l_pspo015 = 0 THEN
               LET l_pspo015 = 1
            END IF
            INSERT INTO pspo_t(pspoent,psposite,pspo001,pspo002,pspo003,
                               pspo004,pspo005,pspo006,pspo007,pspo008,pspo009,
                               pspo010,pspo011,pspo012,pspo013,pspo014,pspo015)
                        VALUES(g_enterprise,p_site,' ',' ',p_order_id,
                               0,'',1,p_qty,1,p_qty,
                               1,p_item,'',1,l_pspo014,l_pspo015)
            IF SQLCA.sqlcode THEN
               INITIALIZE g_errparam TO NULL
               LET g_errparam.code = SQLCA.sqlcode
               LET g_errparam.extend ="xmda_t"

...
#該程式非freestyle程式!
{<section id="aini001.description" type="s" >}
#應用 a00 樣板自動產生(Version:3)
#+ Standard Version.....: SD版次:0026(2019-10-08 17:45:00), PR版次:0026(2020-06-03 16:38:37)
#+ Customerized Version.: SD版次:0000(1900-01-01 00:00:00), PR版次:0000(1900-01-01 00:00:00)
#+ Build......: 000678
#+ Filename...: aini001
#+ Description: 庫位資料維護作業
#+ Creator....: 02294(2013-07-26 11:01:32)
#+ Modifier...: 10983 -SD/PR- 13589
 
{</section>}
 
{<section id="aini001.global" type="s" >}
#應用 t02 樣板自動產生(Version:76)
...
#170617-00512#1   2017/06/17 By 06814   儲位控管:aini001_inaa007_chk(加上條件:需為5.不使用儲位管理 才進行此檢查)
#170930-00015#1   2017/09/30 By 07025   手動輸入標籤時也要同步新增關聯標籤
#170814-00012#10  2017/10/02 By 10044   q_ooeg001_8補上開窗參數,且將其校驗都增加限制法人條件
#181001-00015#57  2018/10/30 By 10554   補上SQL中WHERE漏寫的ent條件
#191005-00013#1   2019/10/07 By 07804   修正標籤編號開窗少了據點條件
#190614-00038#1   2019/10/08 By 10983   增加成本中心说明栏位
#200406-00010#12  2020/06/03 By 13589   隐藏规格【助记码】栏位
#end add-point
...
IMPORT os
IMPORT util
IMPORT JAVA com.fourjs.fgl.lang.FglRecord  #(ver:54) add
...
PRIVATE TYPE type_g_inaa_d RECORD
   ...
   inaa001_desc_desc LIKE inayl_t.inayl004, 
   inaa005 LIKE inaa_t.inaa005, 
   inaa005_desc LIKE ooefl_t.ooefl003, 
   inaa018 LIKE inaa_t.inaa018, 
   inaa018_desc LIKE inayl_t.inayl003, 
...
PRIVATE TYPE type_g_inaa2_d RECORD
   ...
   inaamodid_desc LIKE ooag_t.ooag011, 
   inaamoddt DATETIME YEAR TO SECOND, 
   inaaownid LIKE inaa_t.inaaownid, 
   inaaownid_desc LIKE ooag_t.ooag011, 
   inaaowndp LIKE inaa_t.inaaowndp, 
   inaaowndp_desc LIKE ooefl_t.ooefl003, 
   inaacrtid LIKE inaa_t.inaacrtid, 
   inaacrtid_desc LIKE ooag_t.ooag011, 
   inaacrtdp LIKE inaa_t.inaacrtdp, 
   inaacrtdp_desc LIKE ooefl_t.ooefl003, 
...
{<section id="aini001.main" type="s" >}
...
{<section id="aini001.init" type="s" >}
#+ 畫面資料初始化
...
{<section id="aini001.ui_dialog" type="s" >}
#+ 功能選單 
...
#  LET gfrm_curr = gwin_curr.getForm()      #180517-00033 mark
   ...
   CALL cl_user_overview_set_follow_pic()
               ...
               LET g_data_owner = g_inaa2_d[g_detail_idx].inaaownid   #170804-00012
               LET g_data_dept = g_inaa2_d[g_detail_idx].inaaowndp  #170804-00012
               LET g_data_crtid = g_inaa2_d[g_detail_idx].inaacrtid   #180201-00054
               LET g_data_crtdp = g_inaa2_d[g_detail_idx].inaacrtdp   #180201-00054
               LET g_current_page = 1   #(ver:50)
   ...
   CALL cl_user_overview_set_follow_pic()
         ...
         DISPLAY ARRAY g_inaa3_d TO s_detail3.*
            ...
            BEFORE ROW
               ...
               LET g_master.* = g_inaa_d[g_detail_idx].*
               CALL cl_show_fld_cont() 
               LET g_current_page = 3   #(ver:50)
               #180326-00022 - S -
               #add-point:ON ACTION agendum name="ui_dialog.body3.before_row"
         ...
         IF cl_auth_chk_act("exporttoexcel") THEN
            ...
            CASE
               ...
               -----2015-1-9 zj mod
                  ...
                  CALL cl_export_to_excel_getpage()
                  CALL cl_export_to_excel()
                  #add-point:ON ACTION exporttoexcel name="menu.exporttoexcel_after"   #(ver:48)
...
{<section id="aini001.query" type="s" >}
#+ QBE資料查詢
PRIVATE FUNCTION aini001_query()
   ...
   DIALOG ATTRIBUTES(UNBUFFERED,FIELD ORDER FORM)
      ...
      CONSTRUCT g_wc_table ON inaastus,inaa001,inaa005,inaa018,inaa006,inaa007,inaa008,inaa009,inaa010,inaa014,inaa015,inaa017,inaa016,inaa011,inaa012,inaa013,inaamodid,inaamoddt,inaaownid,inaaowndp,inaacrtid,inaacrtdp,inaacrtdt
           FROM s_detail1[1].inaastus,s_detail1[1].inaa001,s_detail1[1].inaa005,s_detail1[1].inaa018,s_detail1[1].inaa006,s_detail1[1].inaa007,s_detail1[1].inaa008,s_detail1[1].inaa009,s_detail1[1].inaa010,s_detail1[1].inaa014,s_detail1[1].inaa015,s_detail1[1].inaa017,s_detail1[1].inaa016,s_detail1[1].inaa011, 
               s_detail1[1].inaa012,s_detail1[1].inaa013,s_detail2[1].inaamodid,s_detail2[1].inaamoddt,s_detail2[1].inaaownid,s_detail2[1].inaaowndp,s_detail2[1].inaacrtid,s_detail2[1].inaacrtdp,s_detail2[1].inaacrtdt
...
#此ctrlp無內容         ON ACTION controlp INFIELD inaastus
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa006
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa007
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa008
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa009
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa010
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa014
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa015
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa017
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa016
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa011
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa012
         ...
         #應用 a03 樣板自動產生(Version:3)
#此ctrlp無內容         ON ACTION controlp INFIELD inaa013
      ...
      #  CALL cl_qbe_list('m') RETURNING ls_wc
         ...
         CALL cl_qbe_list('c') RETURNING ls_wc   #(ver:51)
   ...
   #181122-00035#1
   #add-point:cquery段after_construct name="query.after_construct"
...
{<section id="aini001.insert" type="s" >}
#+ 資料修改
PRIVATE FUNCTION aini001_insert()
   ...
   LET g_insert = 'Y'
   CALL aini001_input('a')
   LET g_action_choice = ""   #170804-00012 add
...
{<section id="aini001.modify" type="s" >}
#+ 資料新增
...
{<section id="aini001.delete" type="s" >}
#+ 資料刪除
PRIVATE FUNCTION aini001_delete()
   ...
   #170804-00012 ---add start---
   #確定是否有刪除的權限
   #先確定該table有ownid
#  IF cl_getField("inaa_t","inaaownid") THEN   #171006-00020 mark
   IF cl_getField("inaa_t","inaaownid") THEN   #171006-00020 modify
   ...
   IF SQLCA.SQLCODE THEN
      ...
      RETURN
#  ELSE   #(ver:49) mark
#     CALL s_transaction_end('Y','0')   #(ver:49) mark
   END IF
...
{<section id="aini001.input" type="s" >}
#+ 資料輸入
PRIVATE FUNCTION aini001_input(p_cmd)
   ...
   DEFINE l_oocr003       LIKE oocr_t.oocr003   #170930-00015#1 add
   #end add-point 
...
#  LET g_action_choice = ""   #170804-00012 mark
   ...
   #end add-point 
   LET g_forupd_sql = "SELECT inaastus,inaa001,inaa005,inaa018,inaa006,inaa007,inaa008,inaa009,inaa010,inaa014,inaa015,inaa017,inaa016,inaa011,inaa012,inaa013,inaa001,inaamodid,inaamoddt,inaaownid,inaaowndp,inaacrtid,inaacrtdp,inaacrtdt FROM inaa_t WHERE inaaent=? AND inaasite=? AND inaa001=? FOR UPDATE" 
   ...
   #end add-point 
   LET g_forupd_sql = "SELECT inac002,inac003 FROM inac_t WHERE inacent=? AND inacsite=? AND inac001=? AND inac002=? AND inac003=? FOR UPDATE"
   ...
   DIALOG ATTRIBUTES(UNBUFFERED,FIELD ORDER FORM)
      ...
      INPUT ARRAY g_inaa_d FROM s_detail1.*
         ...
         BEFORE INPUT
           ...
           END IF 
            ...
            LET g_current_page = 1
            IF p_cmd = 'u' THEN
               LET g_action_choice = "modify"   #170804-00012
               CALL aini001_b_fill(g_wc)
            END IF
            LET g_loc = 'm'
         ...
         BEFORE ROW
            ...
            THEN
               ...
               IF NOT aini001_lock_b("inaa_t") THEN
                  LET l_lock_sw='Y'
               ELSE
                  FETCH aini001_bcl INTO g_inaa_d[l_ac].inaastus,g_inaa_d[l_ac].inaa001,g_inaa_d[l_ac].inaa005,g_inaa_d[l_ac].inaa018,g_inaa_d[l_ac].inaa006,g_inaa_d[l_ac].inaa007,g_inaa_d[l_ac].inaa008,g_inaa_d[l_ac].inaa009,g_inaa_d[l_ac].inaa010,g_inaa_d[l_ac].inaa014,g_inaa_d[l_ac].inaa015,g_inaa_d[l_ac].inaa017, 
                      g_inaa_d[l_ac].inaa016,g_inaa_d[l_ac].inaa011,g_inaa_d[l_ac].inaa012,g_inaa_d[l_ac].inaa013,g_inaa2_d[l_ac].inaa001,g_inaa2_d[l_ac].inaamodid,g_inaa2_d[l_ac].inaamoddt,g_inaa2_d[l_ac].inaaownid,g_inaa2_d[l_ac].inaaowndp,g_inaa2_d[l_ac].inaacrtid,g_inaa2_d[l_ac].inaacrtdp,g_inaa2_d[l_ac].inaacrtdt 
                  ...
                  IF SQLCA.SQLCODE THEN
                     ...
                     LET g_errparam.code = SQLCA.SQLCODE 
                     LET g_errparam.popup = TRUE 
                     CALL s_transaction_end('N','0')   #(ver:47)   #190806-00019
                     CALL cl_err()
                     LET l_lock_sw = "Y"
                     RETURN   #190806-00019
                  END IF
      ...
      LET g_inaa_d[l_ac].inaa012 = "N"
         ...
         AFTER INSERT
            ...
            ELSE    
               INITIALIZE g_inaa_d[l_ac].* TO NULL
            #  CALL s_transaction_end('N','0')   #(ver:47)
               INITIALIZE g_errparam TO NULL 
         ...
         AFTER FIELD inaa005
            ...
            IF NOT cl_null(g_inaa_d[l_ac].inaa005) THEN 
               IF l_cmd = 'a' OR ( l_cmd = 'u' AND ( l_cmd = 'u' AND (g_inaa_d[l_ac].inaa005 != g_inaa_d_t.inaa005 OR g_inaa_d_t.inaa005 IS NULL))) THEN  #161019-00017#1 add g_inaa_d_t.inaa005 IS NULL
                  ...
                  LET g_chkparam.arg3 = g_site     #170814-00012#10 add  by10044                  
               ...
               END IF
            END IF
            #190614-00038#1---add---s
            SELECT ooefl003 INTO g_inaa_d[l_ac].inaa005_desc FROM ooefl_t
             WHERE ooeflent = g_enterprise
               AND ooefl001 = g_inaa_d[l_ac].inaa005
               AND ooefl002 = g_dlang
            #190614-00038#1---add---e
            #END add-point
...
#此段落由子樣板a07產生 
            ...
            #開窗i段
            INITIALIZE g_qryparam.* TO NULL    #170814-00012#10 add  by10044
            LET g_qryparam.state = 'i'         #170814-00012#10 add  by10044
            LET g_qryparam.reqry = FALSE

            LET g_qryparam.default1 = g_inaa_d[l_ac].inaa005             #給予default值

            #給予arg
            LET g_qryparam.arg1 = g_today  #170814-00012#10 add  by10044
            LET g_qryparam.arg2 = g_site   #170814-00012#10 add  by10044
            #CALL q_ooea001()                                #呼叫開窗
...
LET g_inaa2_d[l_ac].inaamodid_desc = cl_get_username(g_inaa2_d[l_ac].inaamodid)
               ...
               UPDATE inaa_t SET (inaastus,inaa001,inaa005,inaa018,inaa006,inaa007,inaa008,inaa009,inaa010,inaa014,inaa015,inaa017,inaa016,inaa011,inaa012,inaa013,inaamodid,inaamoddt,inaaownid,inaaowndp,inaacrtid,inaacrtdp,inaacrtdt) = (g_inaa_d[l_ac].inaastus,g_inaa_d[l_ac].inaa001,g_inaa_d[l_ac].inaa005, 
                   g_inaa_d[l_ac].inaa018,g_inaa_d[l_ac].inaa006,g_inaa_d[l_ac].inaa007,g_inaa_d[l_ac].inaa008,g_inaa_d[l_ac].inaa009,g_inaa_d[l_ac].inaa010,g_inaa_d[l_ac].inaa014,g_inaa_d[l_ac].inaa015,g_inaa_d[l_ac].inaa017,g_inaa_d[l_ac].inaa016,g_inaa_d[l_ac].inaa011,g_inaa_d[l_ac].inaa012,g_inaa_d[l_ac].inaa013, 
                   g_inaa2_d[l_ac].inaamodid,g_inaa2_d[l_ac].inaamoddt,g_inaa2_d[l_ac].inaaownid,g_inaa2_d[l_ac].inaaowndp,g_inaa2_d[l_ac].inaacrtid,g_inaa2_d[l_ac].inaacrtdp,g_inaa2_d[l_ac].inaacrtdt)
                WHERE inaaent = g_enterprise AND inaasite = g_site AND
      ...
      INPUT ARRAY g_inaa3_d FROM s_detail3.*
         ...
         BEFORE DELETE                            #是否取消單身
            ...
            ELSE
               ...
               #確定是否有刪除的權限
               #先確定該table有ownid
               IF cl_getField("inac_t","inaaownid") THEN
                  LET g_data_owner = g_inaa2_d[g_detail_idx].inaaownid
                  LET g_data_dept = g_inaa2_d[g_detail_idx].inaaowndp
                  LET g_data_crtid = g_inaa2_d[g_detail_idx].inaacrtid   #180201-00054
                  LET g_data_crtdp = g_inaa2_d[g_detail_idx].inaacrtdp   #180201-00054
         ...
         AFTER INSERT    
            ...
            ELSE
               ...
               #170930-00015#1--add--start--      
               #關聯標籤同步新增
               DECLARE oocr003_cs1 CURSOR FOR 
                  SELECT oocr003 FROM oocr_t 
                  WHERE oocrent = g_enterprise AND oocr001 = '220' AND oocr002 = g_inaa3_d[l_ac].inac003 AND oocrstus = 'Y'
                    AND oocr003 NOT IN (SELECT inac003 FROM inac_t WHERE inacent = g_enterprise AND inac001 = g_master.inaa001 AND inac002 = ' ')  
               FOREACH oocr003_cs1 INTO l_oocr003
                  INSERT INTO inac_t
                        (inacent, inacsite,inac001,inac002,inac003,inacstus,
                         inacownid,inacowndp,inaccrtid,inaccrtdp,inaccrtdt
                         ) 
                  VALUES(g_enterprise, g_site,g_master.inaa001,' ',l_oocr003,'Y',
         ...
         ON ROW CHANGE 
            ...
            ELSE
               ...
               UPDATE inac_t SET (inac002,inac003) = (g_inaa3_d[l_ac].inac002,g_inaa3_d[l_ac].inac003) #自訂欄位頁簽
                WHERE inacent = g_enterprise AND inacsite = g_site AND
                   inac001 = g_master.inaa001
                   AND inac002 = g_inaa3_d_t.inac002
                   AND inac003 = g_inaa3_d_t.inac003
...
#此段落由子樣板a07產生 
            ...
            IF l_cmd = 'a' THEN
               LET g_qryparam.state = "c"
              #LET g_qryparam.where = " oocqstus = 'Y' AND oocq002 NOT IN (SELECT inac003 FROM inac_t WHERE inac001 = '",g_master.inaa001,"' AND inac002 = '",g_inaa3_d[l_ac].inac002,"') " #181001-00015#57 mark
               LET g_qryparam.where = " oocqstus = 'Y' AND oocq002 NOT IN (SELECT inac003 FROM inac_t ",                         #181001-00015#57  add
                                         #" WHERE inacent = ",g_enterprise," AND inac001 = '",g_master.inaa001,"' AND inac002 = '",g_inaa3_d[l_ac].inac002,"') " #181001-00015#57  add   #191005-00013#1 mark
                                         #191005-00013#1-(S) add
                                         " WHERE inacent = ",g_enterprise," AND inac001 = '",g_master.inaa001,"' AND inac002 = '",g_inaa3_d[l_ac].inac002,"' ",
                                         "   AND inacsite = '",g_site,"'", 
                                         " ) "
                                         #191005-00013#1-(E) add                                         
            ELSE
               LET g_qryparam.state = "i"
            END IF
      ...
      BEFORE DIALOG 
         ...
         IF g_inaa_d.getLength() > 0 THEN
            CASE g_aw
               WHEN "s_detail1"
                  NEXT FIELD inaastus #170906-00011#1
...
{<section id="aini001.b_fill" type="s" >}
#+ 單身陣列填充
PRIVATE FUNCTION aini001_b_fill(p_wc2)
   ...
   DEFINE p_wc2            STRING
   DEFINE l_ac_t           LIKE type_t.num10
   DEFINE ls_owndept_list  STRING  #170804-00012 add
   DEFINE ls_ownuser_list  STRING  #170804-00012 add
   ...
   LET g_sql = "SELECT  DISTINCT t0.inaastus,t0.inaa001,t0.inaa005,t0.inaa018,t0.inaa006,t0.inaa007,t0.inaa008,t0.inaa009,t0.inaa010,t0.inaa014,t0.inaa015,t0.inaa017,t0.inaa016,t0.inaa011,t0.inaa012,t0.inaa013,t0.inaa001,t0.inaamodid,t0.inaamoddt,t0.inaaownid,t0.inaaowndp,t0.inaacrtid,t0.inaacrtdp,t0.inaacrtdt , 
       t1.inayl003 ,t2.inayl004 ,t3.ooefl003 ,t4.inayl003 ,t5.ooag011 ,t6.ooag011 ,t7.ooefl003 ,t8.ooag011 ,t9.ooefl003 FROM inaa_t t0",
               ...
               " LEFT JOIN inayl_t t4 ON t4.inaylent="||g_enterprise||" AND t4.inayl001=t0.inaa018 AND t4.inayl002='"||g_dlang||"' ",
               " LEFT JOIN ooag_t t5 ON t5.ooagent="||g_enterprise||" AND t5.ooag001=t0.inaamodid  ",
               " LEFT JOIN ooag_t t6 ON t6.ooagent="||g_enterprise||" AND t6.ooag001=t0.inaaownid  ",
               " LEFT JOIN ooefl_t t7 ON t7.ooeflent="||g_enterprise||" AND t7.ooefl001=t0.inaaowndp AND t7.ooefl002='"||g_dlang||"' ",
               " LEFT JOIN ooag_t t8 ON t8.ooagent="||g_enterprise||" AND t8.ooag001=t0.inaacrtid  ",
               " LEFT JOIN ooefl_t t9 ON t9.ooeflent="||g_enterprise||" AND t9.ooefl001=t0.inaacrtdp AND t9.ooefl002='"||g_dlang||"' ",
...
#  IF g_action_choice = "modify" OR g_action_choice = "modify_detail" THEN   #(ver:2) mark
   ...
   THEN
      ...
      #  LET g_sql = g_sql, " AND inaaowndp IN (",ls_owndept_list,")"   #180201-00054 mark
         LET g_sql = g_sql, " AND (inaaowndp IN (",ls_owndept_list,")",  #180201-00054 modify
                                 " OR (inaacrtid = '",g_user,"' AND inaacrtdp = '",g_dept,"'))"   #180201-00054 modify
      END IF
 
      #若有設定個人權限
      CALL cl_get_ownuser_list("inaa_t","modify") RETURNING ls_ownuser_list
      IF NOT cl_null(ls_ownuser_list) THEN
      #  LET g_sql = g_sql," AND inaaownid IN (",ls_ownuser_list,")"   ##180201-00054 mark
         LET g_sql = g_sql," AND (inaaownid IN (",ls_ownuser_list,") OR inaacrtid = '",g_user,"')"   #180201-00054 modify
      END IF
   END IF
   ...
   #OPEN b_fill_curs USING g_enterprise, g_site #181211-00007#1
   ...
   LET g_cnt = l_ac
   LET l_ac = 1   
#  ERROR "Searching!"    #170804-00012 mark
 
   FOREACH b_fill_curs USING g_enterprise, g_site INTO g_inaa_d[l_ac].inaastus,g_inaa_d[l_ac].inaa001,g_inaa_d[l_ac].inaa005,g_inaa_d[l_ac].inaa018,g_inaa_d[l_ac].inaa006,g_inaa_d[l_ac].inaa007,g_inaa_d[l_ac].inaa008,g_inaa_d[l_ac].inaa009,g_inaa_d[l_ac].inaa010,g_inaa_d[l_ac].inaa014,g_inaa_d[l_ac].inaa015, 
       g_inaa_d[l_ac].inaa017,g_inaa_d[l_ac].inaa016,g_inaa_d[l_ac].inaa011,g_inaa_d[l_ac].inaa012,g_inaa_d[l_ac].inaa013,g_inaa2_d[l_ac].inaa001,g_inaa2_d[l_ac].inaamodid,g_inaa2_d[l_ac].inaamoddt,g_inaa2_d[l_ac].inaaownid,g_inaa2_d[l_ac].inaaowndp,g_inaa2_d[l_ac].inaacrtid,g_inaa2_d[l_ac].inaacrtdp, 
       g_inaa2_d[l_ac].inaacrtdt,g_inaa_d[l_ac].inaa001_desc,g_inaa_d[l_ac].inaa001_desc_desc,g_inaa_d[l_ac].inaa005_desc,g_inaa_d[l_ac].inaa018_desc,g_inaa2_d[l_ac].inaamodid_desc,g_inaa2_d[l_ac].inaaownid_desc,g_inaa2_d[l_ac].inaaowndp_desc,g_inaa2_d[l_ac].inaacrtid_desc,g_inaa2_d[l_ac].inaacrtdp_desc  
       #181211-00007#1
      IF SQLCA.SQLCODE THEN
         INITIALIZE g_errparam TO NULL 
   ...
   #181122-00035#1
   #add-point:b_fill段after_construct name="b_fill.after"
   
   #end add-point
   #181122-00035#1
   
#  ERROR ""    #170804-00012 mark
   
END FUNCTION
 
{</section>}
 
{<section id="aini001.fetch" type="s" >}
#+ 單身陣列填充2
PRIVATE FUNCTION aini001_fetch()
   ...
   IF (g_action_choice = "query" OR cl_null(g_action_choice))
      ...
      #end add-point
   THEN
      LET g_sql = "SELECT  DISTINCT t0.inac002,t0.inac003 ,t10.oocql004 FROM inac_t t0",    
                  "",
                                 " LEFT JOIN oocql_t t10 ON t10.oocqlent="||g_enterprise||" AND t10.oocql001='220' AND t10.oocql002=t0.inac003 AND t10.oocql003='"||g_dlang||"' ",
...
#  LET l_ac = g_detail_idx   #(ver:45)
   ...
   LET l_ac = 1
   FOREACH b_fill_curs2 USING g_enterprise, g_site,g_inaa_d[g_detail_idx].inaa001 INTO g_inaa3_d[l_ac].inac002,g_inaa3_d[l_ac].inac003,g_inaa3_d[l_ac].inac003_desc   #(ver:45) #(ver:46)
      IF SQLCA.SQLCODE THEN
         INITIALIZE g_errparam TO NULL 
         LET g_errparam.extend = "FOREACH:",SQLERRMESSAGE 
         LET g_errparam.code = SQLCA.SQLCODE 
...
{<section id="aini001.detail_show" type="s" >}
#+ 顯示相關資料
...
{<section id="aini001.set_entry_b" type="s" >}
#+ 單身欄位開啟設定
...
{<section id="aini001.set_no_entry_b" type="s" >}
#+ 單身欄位關閉設定
...
{<section id="aini001.default_search" type="s" >}
#+ 外部參數搜尋
...
{<section id="aini001.delete_b" type="s" >}
#+ 刪除單身後其他table連動
...
{<section id="aini001.insert_b" type="s" >}
#+ 新增單身後其他table連動
PRIVATE FUNCTION aini001_insert_b(ps_table,ps_keys,ps_page)
   ...
   IF ls_group.getIndexOf(ps_table,1) > 0 THEN
      ...
      LET lp_js = util.JSON.stringify(g_inaa_d[l_ac])
      CALL cl_auth_belong_data(lp_js,"inaa_t") RETURNING g_inaa2_d[g_detail_idx].inaaownid,g_inaa2_d[g_detail_idx].inaaowndp
      #190412-00022 --- end ---
      ...
      INSERT INTO inaa_t
            ...
            VALUES(g_enterprise, g_site,
                   ps_keys[1]
                   ,g_inaa_d[g_detail_idx].inaastus,g_inaa_d[g_detail_idx].inaa005,g_inaa_d[g_detail_idx].inaa018,g_inaa_d[g_detail_idx].inaa006,g_inaa_d[g_detail_idx].inaa007,g_inaa_d[g_detail_idx].inaa008,g_inaa_d[g_detail_idx].inaa009,g_inaa_d[g_detail_idx].inaa010,g_inaa_d[g_detail_idx].inaa014, 
                       g_inaa_d[g_detail_idx].inaa015,g_inaa_d[g_detail_idx].inaa017,g_inaa_d[g_detail_idx].inaa016,g_inaa_d[g_detail_idx].inaa011,g_inaa_d[g_detail_idx].inaa012,g_inaa_d[g_detail_idx].inaa013,g_inaa2_d[g_detail_idx].inaamodid,g_inaa2_d[g_detail_idx].inaamoddt,g_inaa2_d[g_detail_idx].inaaownid, 
                       g_inaa2_d[g_detail_idx].inaaowndp,g_inaa2_d[g_detail_idx].inaacrtid,g_inaa2_d[g_detail_idx].inaacrtdp,g_inaa2_d[g_detail_idx].inaacrtdt)
...
{<section id="aini001.update_b" type="s" >}
#+ 修改單身後其他table連動
   ...
   IF ls_group.getIndexOf(ps_table,1) > 0 AND ps_table <> "inaa_t" THEN
      ...
      UPDATE inaa_t 
         SET (inaa001
              ...
              = 
             (ps_keys[1]
              ,g_inaa_d[g_detail_idx].inaastus,g_inaa_d[g_detail_idx].inaa005,g_inaa_d[g_detail_idx].inaa018,g_inaa_d[g_detail_idx].inaa006,g_inaa_d[g_detail_idx].inaa007,g_inaa_d[g_detail_idx].inaa008,g_inaa_d[g_detail_idx].inaa009,g_inaa_d[g_detail_idx].inaa010,g_inaa_d[g_detail_idx].inaa014,g_inaa_d[g_detail_idx].inaa015, 
                  g_inaa_d[g_detail_idx].inaa017,g_inaa_d[g_detail_idx].inaa016,g_inaa_d[g_detail_idx].inaa011,g_inaa_d[g_detail_idx].inaa012,g_inaa_d[g_detail_idx].inaa013,g_inaa2_d[g_detail_idx].inaamodid,g_inaa2_d[g_detail_idx].inaamoddt,g_inaa2_d[g_detail_idx].inaaownid,g_inaa2_d[g_detail_idx].inaaowndp, 
                  g_inaa2_d[g_detail_idx].inaacrtid,g_inaa2_d[g_detail_idx].inaacrtdp,g_inaa2_d[g_detail_idx].inaacrtdt) 
         WHERE inaaent = g_enterprise AND inaasite = g_site AND
               inaa001 = ps_keys_bak[1]
...
{<section id="aini001.key_update_b" type="s" >}
...
{<section id="aini001.lock_b" type="s" >}
#+ 連動lock其他單身table資料
...
{<section id="aini001.unlock_b" type="s" >}
#+ 連動unlock其他單身table資料
...
{<section id="aini001.idx_chk" type="s" >}
#+ 單身筆數變更
PRIVATE FUNCTION aini001_idx_chk(ps_loc)
   ...
   LET g_curr_diag = ui.DIALOG.getCurrent() #(ver:50)
...
{<section id="aini001.show_ownid_msg" type="s" >}
#+ 判斷是否顯示只能修改自己權限資料的訊息
#170804-00012 ---add start---
PRIVATE FUNCTION aini001_show_ownid_msg()
...
{<section id="aini001.mask_functions" type="s" >}
&include "erp/ain/aini001_mask.4gl"
 
{</section>}
 
{<section id="aini001.set_pk_array" type="s" >}
...
{<section id="aini001.state_change" type="s" >}
    
 
{</section>}
 
{<section id="aini001.func_signature" type="s" >}
   
 
{</section>}
 
{<section id="aini001.other_dialog" readonly="Y" type="s" >}
 
 
{</section>}
 
{<section id="aini001.other_function" readonly="Y" type="s" >}
#+
...
DEFINE r_success   LIKE type_t.num5
      ...
      LET r_success = TRUE
      IF g_inaa_d[l_ac].inaa007 ='5' THEN   #170617-00512#1 20170617 add by beckxie
         LET l_n = 0
         ...
         IF l_n > 0 THEN
            ...
            RETURN r_success
         END IF
      END IF                                #170617-00512#1 20170617 add by beckxie
      RETURN r_success
